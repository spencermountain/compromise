module.exports = {
  json: {
    ...
    example:
      "nlp('I’d like to request seventeen dollars for a push broom rebristling').values().data()\n//[{number:17, TextValue:{ Ordinal:'seventeenth'}, NumericValue:{ Ordinal:'17th'}} ]",
    returns: 'array',
  },
  // noDates: {
  ...
  toLocaleString: {
    ...
    returns: 'Doc',
    example:
      "nlp('five hundred sixty two thousand, four hundred and seven').values().toLocaleString().all().out()\n//'562,407'",
  },
  toCardinal: {
