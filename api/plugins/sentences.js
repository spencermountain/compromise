module.exports = {
  ...
  prepend: {
    ...
    returns: 'Text',
    example:
      "nlp('I know so many words.').sentences().prepend('believe me').out()\n//Believe me, I know so many words.",
  },
  append: {
  ...
  toNegative: {
    ...
    returns: 'Text',
    example:
      "nlp('Now make like my pants, and split.').sentences(0).toNegative().out()\n//Now do not make like my pants, and split.",
  },
  toPositive: {
  ...
  toStatement: {
    ...
    returns: 'Text',
    example:
      "nlp('Go out on a Tuesday? Who am I, Charlie Sheen?').sentences(0).toStatement().out()\n//Go out on a Tuesday. Who am I, Charlie Sheen?",
  },
}
