(function (global, factory) {
  ...
  var textOut = function(options, first, last) {
    let word = this.text;
    let before = this.pre;
    let after = this.post;
  ...
  */
  ...
  var replaceWith = function(replace) {
    this.list.forEach(p => {
  ...
  var replace$1 = function(match, replace) {
    this.match(match).replaceWith(replace);
    return this
  };

  /** fully remove these terms from the document */
  var delete_1$1 = function(match) {
    this.unfreeze();
    let toRemove = this;
    if (match) {
  ...
  var _09Out_5 = _09Out.normal;
  var _09Out_6 = _09Out.data;
