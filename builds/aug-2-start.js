(function (global, factory) {
  ...
  const addWhitespace$1 = function(original, newPhrase, newTerms) {
    ...
    if (term.prev) {
      ...
      if (hasSpace$1.test(firstWord.pre) === false) {
        firstWord.pre = ' ' + firstWord.pre;
      }
      return
    }
    //otherwise, add our space to the start of original
    if (hasSpace$1.test(term.pre) === false) {
      term.pre = ' ' + term.pre;
    }
    return
  };
  ...
  */
  ...
  var _09Output = createCommonjsModule(function (module, exports) {
  ...
  var _09Output_1 = _09Output.text;
  var _09Output_2 = _09Output.json;
  var _09Output_3 = _09Output.debug;
  var _09Output_4 = _09Output.out;
  var _09Output_5 = _09Output.data;
  ...
  var _10Split_5 = _10Split.concat;
  ...
  */
  ...
  var parentheses$1 = addMethod$2;

  const selections$1 = [acronyms, contractions$1, parentheses$1];
