...
const findMethods = _dereq_('./find')
...
const failFast = _dereq_('./02-failFast')
const tryMatch = _dereq_('./03-tryMatch')
...
const matchAll = _dereq_('./01-matchAll')
const notMatch = _dereq_('./not')
...
const append = _dereq_('./_join/append')
const prepend = _dereq_('./_join/prepend')
...
const doesMatch = _dereq_('./_match')
const out = _dereq_('./04-out')
...
const World = _dereq_('./world/index')
...
const abbreviations = _dereq_('../../tokenizer/lib/abbreviations')
