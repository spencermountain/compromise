...
const checkRegex = _dereq_('./02-regex');
const checkPunctuation = _dereq_('./03-punctuation');
const checkEmoji = _dereq_('./04-emoji');
...
const corrections = _dereq_('./04-corrections');
