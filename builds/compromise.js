...
var quick = _dereq_('./selections/quick');

Object.keys(quick).forEach(function (k) {
  Doc.prototype[k] = function () {
    var matches = quick[k](this);
    return new Doc(matches.list, this, this.world);
  };
}); //ones with subclasses

var selections = _dereq_('./selections');

Object.keys(selections).forEach(function (k) {
  var Sub = selections[k].subclass(Doc);

  Doc.prototype[k] = function () {
    var matches = selections[k].find(this);
    return new Sub(matches.list, this, this.world);
  };
});
module.exports = Doc;

},{"../tagger":59,"./easy":4,"./hard":5,"./match":6,"./out":10,"./selections":11,"./selections/quick":14,"./utilities":15}],4:[function(_dereq_,module,exports){
"use strict";
...
},{"../build":39}],6:[function(_dereq_,module,exports){
"use strict";

var parseSyntax = _dereq_('./syntax');

var matchMethods = function matchMethods(Doc) {
  var methods = {
    //return a new Doc, with us as a parent
    match: function match(reg) {
    ...
    matchOne: function matchOne(reg) {
      var regs = parseSyntax(reg);
      var found = doc.list.find(function (p) {
        return p.match(regs).length > 0;
      });
      return new Doc([found], this, this.world);
    },
    split: function split(reg) {
      var regs = parseSyntax(reg);
      var matches = [];
      this.list.forEach(function (p) {
        var found = p.match(regs); //no match, keep it going
...
},{"../../world/tags":74}],10:[function(_dereq_,module,exports){
"use strict";

var _debug = _dereq_('./debug'); // output
...
},{"./nouns":13,"./nouns/Noun":12}],12:[function(_dereq_,module,exports){
"use strict";
...
//build this class 
var subClass = function subClass(Document) {
  var Noun =
  /*#__PURE__*/
  function (_Document) {
    _inherits(Noun, _Document);

    function Noun() {
      _classCallCheck(this, Noun);

      return _possibleConstructorReturn(this, _getPrototypeOf(Noun).apply(this, arguments));
    }
...
module.exports = {
  tag: function tag(_tag, why) {
    ...
    this.list.forEach(function (p) {
      p.terms().forEach(function (t) {
        return t.tag(_tag, why, _this.world);
      });
    });
    return this;
  },
...
var notMatch = _dereq_('./match/not');
...
Phrase.prototype.not = function (str) {
  ...
  matches = matches.map(function (list) {
    return new Phrase(list[0].id, list.length, _this3.pool);
  });
  return matches;
...
Phrase.prototype.splitOn = function (p) {
  ...
  var end = terms.slice(index + p.length, terms.length); //make all three sections into phrase-objects
...
},{"./hard":17,"./match":22,"./match/not":23}],17:[function(_dereq_,module,exports){
"use strict";

var _append = _dereq_('./join/append');

var _prepend = _dereq_('./join/prepend'); // const insertAfter = require('./insert/after');


module.exports = {
  //accept a phrase object and put it at the end
  append: function append(phrase, doc) {
    _append(this, phrase, doc);

    return this;
  },
  prepend: function prepend(phrase, doc) {
    _prepend(this, phrase, doc);

    return this;
  }
};

},{"./join/append":18,"./join/prepend":19}],18:[function(_dereq_,module,exports){
"use strict";
...
var tryMatch = _dereq_('./02-tryMatch');

var syntax = _dereq_('../../01-doc/match/syntax'); //returns a simple array of arrays
...
},{"../../01-doc/match/syntax":8,"./01-failFast":20,"./02-tryMatch":21}],23:[function(_dereq_,module,exports){
"use strict";

var matchAll = _dereq_('./index'); //return anything that doesn't match.
...
},{"./index":22}],24:[function(_dereq_,module,exports){
"use strict";
...
var output = _dereq_('./out');

var tagAs = _dereq_('./tag/tag');
...
},{"./_id":25,"./easy":26,"./out":31,"./parse":32,"./tag/tag":34,"./tag/untag":35}],25:[function(_dereq_,module,exports){
"use strict";
...
module.exports = {
  ...
  hasElipses: function hasElipses() {
    return this.postText.includes('..') || this.postText.includes('…');
  },
  hasSemicolon: function hasSemicolon() {
    return this.postText.includes(';');
  },
  punctuation: function punctuation() {
  ...
  normalizeWhitespace: function normalizeWhitespace() {
...
},{"./match":27}],27:[function(_dereq_,module,exports){
"use strict";
...
},{"./isAcronym":29,"./unicode":30}],29:[function(_dereq_,module,exports){
"use strict";
...
var endings = /[ \.’'\[\](){}⟨⟩:,،、‒–—―…!.‹›«»‐\-?‘’“”'";\/⁄·\&*@\•^†‡°”¡¿※#№÷×ºª%‰+−=‱¶′″‴§~_|‖¦©℗®℠™¤₳฿]+$/;
var startings = /^[ \.’'\[\](){}⟨⟩:,،、‒–—―…!.‹›«»‐\-?‘’“”'";\/⁄·\&*@\•^†‡°”¡¿※#№÷×ºª%‰+−=‱¶′″‴§~_|‖¦©℗®℠™¤₳฿]+/; // console.log(endings);
...
},{"./normalize":28}],33:[function(_dereq_,module,exports){
"use strict";
...
var addTags = function addTags(tags, reason, world) {
  var _this = this;

  if (fns.isArray(tags) === true) {
    tags.forEach(function (tag) {
      return addTag(_this, tag, reason, world);
    });
  } else {
...
},{"./fns":33}],35:[function(_dereq_,module,exports){
"use strict";
...
var untagAll = function untagAll(tags, reason, world) {
  var _this = this;

  if (fns.isArray(tags) === true) {
    tags.forEach(function (tag) {
      return unTag(_this, tag, reason, world);
    });
  } else {
...
},{"./fns":33}],36:[function(_dereq_,module,exports){
"use strict";
...
},{"./lib/abbreviations":40}],37:[function(_dereq_,module,exports){
"use strict";
...
},{"../02-phrase/Phrase":16,"../03-term/Term":24,"./01-sentences":36,"./02-words":37,"./Pool":38}],40:[function(_dereq_,module,exports){
...
},{"../package.json":2,"./01-doc/Doc":3,"./build":39,"./world":71}],42:[function(_dereq_,module,exports){
"use strict";
...
},{"./regex/endsWith":49,"./regex/startsWith":50,"./regex/suffixList":51}],44:[function(_dereq_,module,exports){
"use strict";
...
},{"./emoji/list":46,"./emoji/regex":47}],46:[function(_dereq_,module,exports){
"use strict";
...
var lookups = function lookups(doc) {
  ...
  for (var i = 0; i < terms.length; i += 1) {
    var term = terms[i]; //don't overwrite existing tags
    ...
    checkRegex(term, world); //or maybe some helpful punctuation
...
},{"./01-lexicon":42,"./02-regex":43,"./03-punctuation":44,"./04-emoji":45}],49:[function(_dereq_,module,exports){
"use strict";
...
},{"./01-neighbours":52}],54:[function(_dereq_,module,exports){
"use strict";
...
},{"../../03-term/Term":24,"./01-negative":54,"./02-apostrophe-s":55,"./03-irregulars":56}],58:[function(_dereq_,module,exports){
"use strict";
...
},{"./01-lookups":48,"./02-fallbacks":53,"./03-contractions":57,"./04-corrections":58}],60:[function(_dereq_,module,exports){
"use strict";
...
var checkSuffix = function checkSuffix(str) {
...
},{"./suffixes":63}],61:[function(_dereq_,module,exports){
...
var fastConjucate = function fastConjucate(str) {
...
},{"./01-suffixes":60,"./02-generic":61}],63:[function(_dereq_,module,exports){
"use strict";
...
},{"./01-suffixes":64}],66:[function(_dereq_,module,exports){
"use strict";
...
},{"../transforms/conjugate":62,"../transforms/inflect":65}],67:[function(_dereq_,module,exports){
"use strict";
...
},{"../transforms/conjugate":62}],68:[function(_dereq_,module,exports){
"use strict";
...
},{"./tags/addDownward":72}],70:[function(_dereq_,module,exports){
"use strict";
...
},{"./01-addWords":66,"./02-conjugations":67,"./03-plurals":68,"./04-addTags":69,"./_data":70,"./tags":74,"efrt-unpack":1}],72:[function(_dereq_,module,exports){
"use strict";
...
},{"./addDownward":72,"./conflicts":73,"./tags/dates":75,"./tags/misc":76,"./tags/nouns":77,"./tags/values":78,"./tags/verbs":79}],75:[function(_dereq_,module,exports){
"use strict";
