...
var conjugate = function conjugate(t, world, verbose) {
...
var toNegative = function toNegative(ts) {
  ...
  if (past.found) {
    ...
    if (isPlural) {
      _vb2 = ts.parentTerms.insertAt(_index2, 'do not', 'Verb');
    }
  ...
  if (verb.found) {
    ...
    var _vb5 = ts.parentTerms.insertAt(_index5, 'did not', 'Verb');
    if (isPlural) {
      _vb5 = ts.parentTerms.insertAt(_index5, 'does not', 'Verb');
    }
  ...
  Object.keys(words).forEach(function (word) {
    ...
    if (tag === 'PhrasalVerb') {
      ...
      Object.keys(_conj).forEach(function (k) {
        ...
        _this.words[form] = [k, 'PhrasalVerb'];
        //add it to cache, too
