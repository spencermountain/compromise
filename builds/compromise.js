...
var unpack = _dereq_('compromise-unpack');
...
var defaultPlurals = _dereq_('../lexicon/uncompressed/irregularPlurals').toPlural;
...
World.prototype.addPlurals = function (plurals) {
  ...
  Object.keys(plurals || {}).forEach(function (k) {
    _this2.plurals[k] = plurals[k];
    //add them both to the lexicon, too
    var plural = plurals[k];
    _this2.words[k] = _this2.words[k] || 'Singular';
    _this2.words[plural] = _this2.words[plural] || 'Plural';
  });
};
World.prototype.addConjugations = function (conjugations) {
  ...
  Object.keys(conjugations || {}).forEach(function (k) {
    _this3.conjugations[k] = conjugations[k];
    //add them both to the lexicon, too
    // let plural = plurals[k];
    _this3.words[k] = _this3.words[k] || 'Infinitive';
