...
},{"../result/subset/adjectives/methods/index":42,"../result/subset/verbs/methods/conjugate/faster":115,"../result/subset/verbs/methods/toAdjective":126,"./fns":5,"./index":6}],8:[function(_dereq_,module,exports){
'use strict';
...
},{"./tags/colors":175}],22:[function(_dereq_,module,exports){
(function (global){
'use strict';
...
//the main thing
var nlp = function nlp(str, lexicon, tagSet, customRules) {
...
var fromString = function fromString(str, lexicon, tagSet, customRules) {
  ...
  var list = sentences.map(function (s) {
    return Terms.fromString(s, lexicon, customRules);
  });
...
},{"../tags":177,"../term/methods/normalize/normalize":184,"./index":25,"./paths":38,"./tokenize":131}],25:[function(_dereq_,module,exports){
'use strict';
...
Text = _dereq_('./methods/lump')(Text);
...
},{"../../terms":197}],27:[function(_dereq_,module,exports){
'use strict';
...
var lumpMethods = function lumpMethods(Text) {
  ...
  var methods = {
    ...
    lumpIntoParent: function lumpIntoParent(tags, description) {
      for (var mI = this.list.length - 1; mI >= 0; mI--) {
        var firstTerm = this.list[mI].firstTerm();
        var lastTerm = this.list[mI].lastTerm();
...
},{"../data":6,"../fns":21,"../log":23,"../tags":177,"../terms":197}],39:[function(_dereq_,module,exports){
'use strict';
...
},{"../../index":25}],40:[function(_dereq_,module,exports){
'use strict';
...
},{"../../index":25,"./methods":42}],41:[function(_dereq_,module,exports){
'use strict';
...
},{"../../index":25,"./toAdjective":49}],49:[function(_dereq_,module,exports){
...
},{"../../index":25}],51:[function(_dereq_,module,exports){
'use strict';
...
},{"../../index":25,"./contraction":52,"./findPossible":53}],55:[function(_dereq_,module,exports){
'use strict';
...
},{"../../index":25,"./date":55,"./month":58,"./weekday":62}],57:[function(_dereq_,module,exports){
'use strict';
...
},{"../../index":25}],64:[function(_dereq_,module,exports){
'use strict';
...
},{"../../index":25,"./getGrams":65}],68:[function(_dereq_,module,exports){
'use strict';
...
},{"../../../tries":238}],70:[function(_dereq_,module,exports){
'use strict';
...
},{"../../index":25,"./noun":78}],71:[function(_dereq_,module,exports){
'use strict';
...
},{"../../index":25}],80:[function(_dereq_,module,exports){
'use strict';
...
},{"../../paths":38}],81:[function(_dereq_,module,exports){
'use strict';
...
},{"../../index":25,"./person":82}],82:[function(_dereq_,module,exports){
'use strict';
...
},{"../../index":25}],84:[function(_dereq_,module,exports){
'use strict';
...
},{"../../index":25,"./place":85}],85:[function(_dereq_,module,exports){
'use strict';
...
},{"../../index":25}],87:[function(_dereq_,module,exports){
'use strict';
...
},{"../../index":25,"./sentence":89}],88:[function(_dereq_,module,exports){
'use strict';
...
},{"../../paths":38,"../verbs/verb":130,"./smartInsert":90,"./toNegative":92,"./toPositive":93}],90:[function(_dereq_,module,exports){
'use strict';
...
},{"../../index":25,"./term":95}],95:[function(_dereq_,module,exports){
'use strict';
...
},{"../../index":25}],98:[function(_dereq_,module,exports){
'use strict';
...
},{"../../index":25,"./value":110}],99:[function(_dereq_,module,exports){
'use strict';
...
},{"../paths":100,"./data":103,"./findModifiers":104,"./parseDecimals":106,"./parseNumeric":107,"./validate":108}],106:[function(_dereq_,module,exports){
'use strict';
...
},{"../../index":25,"./verb":130}],112:[function(_dereq_,module,exports){
'use strict';
...
},{"./methods/predict":124}],113:[function(_dereq_,module,exports){
'use strict';
...
},{"../predict":124,"../toInfinitive":127,"./generic":116,"./irregulars":118,"./suffixes":119,"./toActor":120,"./toAdjective":121,"./toBe":122}],114:[function(_dereq_,module,exports){
'use strict';
...
},{"../../../../../fns":21}],117:[function(_dereq_,module,exports){
'use strict';
...
},{"./conjugate":113,"./toBe":122}],118:[function(_dereq_,module,exports){
'use strict';
...
},{"../../../../../fns":21,"./suffix_rules":125}],125:[function(_dereq_,module,exports){
'use strict';
...
},{"../../../../../data":6,"../predict":124,"./rules":128}],128:[function(_dereq_,module,exports){
'use strict';
...
},{"./methods/toInfinitive":127}],130:[function(_dereq_,module,exports){
'use strict';
...
},{"../../paths":38,"./interpret":112,"./methods/conjugate":117,"./methods/isPlural":123,"./methods/toAdjective":126,"./toNegative":129}],131:[function(_dereq_,module,exports){
...
},{"../data/index":6,"./paths":38}],132:[function(_dereq_,module,exports){
'use strict';
...
},{"./fix":136}],133:[function(_dereq_,module,exports){
'use strict';
...
},{"./fix":136,"./split":138}],134:[function(_dereq_,module,exports){
'use strict';
...
},{"./fix":136,"./split":138}],135:[function(_dereq_,module,exports){
'use strict';
...
},{"../../term":179,"./fix":136}],136:[function(_dereq_,module,exports){
'use strict';
...
},{"../../term":179}],137:[function(_dereq_,module,exports){
'use strict';
...
},{"./01-irregulars":132,"./02-hardOne":133,"./03-easyOnes":134,"./04-numberRange":135}],138:[function(_dereq_,module,exports){
'use strict';
...
},{"../paths":146,"./verb_corrections":140}],140:[function(_dereq_,module,exports){
'use strict';
...
var step = {
  ...
  custom_step: _dereq_('./steps/22-custom_step')
};
var corrections = _dereq_('./corrections');
var tagPhrase = _dereq_('./phrase');

var tagger = function tagger(ts, customRules) {
...
},{"./contraction":137,"./corrections":139,"./lumper/lexicon_lump":143,"./lumper/lump_three":144,"./lumper/lump_two":145,"./phrase":148,"./steps/01-punctuation_step":149,"./steps/02-lexicon_step":150,"./steps/03-capital_step":151,"./steps/04-web_step":152,"./steps/05-suffix_step":153,"./steps/06-neighbour_step":154,"./steps/07-noun_fallback":155,"./steps/08-date_step":156,"./steps/09-auxillary_step":157,"./steps/10-negation_step":158,"./steps/12-phrasal_step":159,"./steps/13-comma_step":160,"./steps/14-possessive_step":161,"./steps/15-value_step":162,"./steps/16-acronym_step":163,"./steps/17-emoji_step":164,"./steps/18-person_step":165,"./steps/19-quotation_step":166,"./steps/20-organization_step":167,"./steps/21-plural_step":168,"./steps/22-custom_step":169}],142:[function(_dereq_,module,exports){
'use strict';
...
},{"../../term":179,"../paths":146}],143:[function(_dereq_,module,exports){
'use strict';
...
},{"../../tries":238,"../paths":146,"./combine":142}],144:[function(_dereq_,module,exports){
'use strict';
...
},{"../paths":146,"./combine":142}],145:[function(_dereq_,module,exports){
'use strict';
...
},{"../paths":146,"./combine":142}],146:[function(_dereq_,module,exports){
'use strict';
...
},{"../data":6,"../data/lexicon":7,"../fns":21,"../log":23,"../tags":177,"../terms":197,"../tries":238}],147:[function(_dereq_,module,exports){
'use strict';
...
},{"./00-conditionPass":147}],149:[function(_dereq_,module,exports){
'use strict';
...
},{"../paths":146,"./rules/punct_rules":173}],150:[function(_dereq_,module,exports){
'use strict';
...
},{"../../tries":238,"../contraction/split":138,"../paths":146}],151:[function(_dereq_,module,exports){
'use strict';
...
},{"../paths":146}],152:[function(_dereq_,module,exports){
'use strict';
...
},{"../paths":146}],153:[function(_dereq_,module,exports){
'use strict';
...
},{"../paths":146,"./rules/word_rules":174}],154:[function(_dereq_,module,exports){
'use strict';
...
},{"../paths":146,"./rules/neighbours":172}],155:[function(_dereq_,module,exports){
'use strict';
...
},{"../paths":146}],156:[function(_dereq_,module,exports){
'use strict';
...
},{"../paths":146}],157:[function(_dereq_,module,exports){
'use strict';
...
},{"../paths":146}],158:[function(_dereq_,module,exports){
'use strict';
...
},{"../paths":146}],159:[function(_dereq_,module,exports){
'use strict';
...
},{"../../result/subset/verbs/methods/toInfinitive/index.js":127,"../paths":146}],160:[function(_dereq_,module,exports){
'use strict';
//-types of comma-use-
...
},{"../paths":146}],163:[function(_dereq_,module,exports){
'use strict';
'use strict';
...
},{"../paths":146}],164:[function(_dereq_,module,exports){
'use strict';
...
},{"../paths":146,"./rules/emoji_regex":170,"./rules/emoticon_list":171}],165:[function(_dereq_,module,exports){
'use strict';
...
},{"../paths":146}],166:[function(_dereq_,module,exports){
'use strict';
...
},{"../paths":146}],167:[function(_dereq_,module,exports){
'use strict';
...
},{"../paths":146}],168:[function(_dereq_,module,exports){
'use strict';
...
},{"../../result/subset/nouns/isPlural":71,"../paths":146}],169:[function(_dereq_,module,exports){
'use strict';
//const path = 'tagger/customPass';
//const mutate = require('../../terms/mutate');

var customStep = function customStep(ts, customRules) {
  ...
  for (var i = 0; i < ts.terms.length; i++) {
    ...
    for (var x = 0; x < customRules.singleTermRegularExpressions.length; x++) {
      var customExpression = customRules.singleTermRegularExpressions[x];
  ...
  //lumps second
  for (var _x = 0; _x < customRules.lumpExpressions.length; _x++) {
    var _customExpression = customRules.lumpExpressions[_x];

    ts.match(_customExpression.match).lumpIntoParent(_customExpression.tags, _customExpression.description);
  }
...
},{"../../paths":194,"dup":100}],192:[function(_dereq_,module,exports){
'use strict';
...
},{"../data":6,"../fns":21,"../log":23,"../tags":177}],195:[function(_dereq_,module,exports){
'use strict';
...
var Terms = function () {
  function Terms(arr, lexicon, refText, refTerms, customRules) {
    var _this = this;
  ...
  _createClass(Terms, [{
    ...
    key: 'fromString',
    value: function fromString(str, lexicon, customRules) {
      var termArr = build(str);
      var ts = new Terms(termArr, lexicon, null, null, customRules);
...
},{"../tagger":141,"./build":196,"./match":198,"./match/not":204,"./methods/delete":205,"./methods/insert":206,"./methods/loops":207,"./methods/lump":208,"./methods/misc":209,"./methods/out":210,"./methods/replace":211,"./methods/split":212,"./methods/tag":213,"./methods/transform":214}],198:[function(_dereq_,module,exports){
'use strict';
//
...
},{"../../result/index":25,"./lib/startHere":202,"./lib/syntax":203}],199:[function(_dereq_,module,exports){
'use strict';
...
},{"../../../fns":21,"../../../log":23}],202:[function(_dereq_,module,exports){
'use strict';
...
},{"../../result/index":25,"./lib/startHere":202,"./lib/syntax":203}],205:[function(_dereq_,module,exports){
'use strict';
...
var combine = _dereq_('../../tagger/lumper/combine');
...
var lumpMethods = function lumpMethods(Terms) {
  ...
  var methods = {
    ...
    lumpIntoOne: function lumpIntoOne(startTerm, endTerm, tag, tagReason) {
      var terms = startTerm.parentTerms;
      var endTermIndex = endTerm.index();
      var startTermIndex = startTerm.index();
      for (var i = endTermIndex - 1; i >= startTermIndex; i--) {
        combine(terms, i);
      }
...
},{"../../tagger/lumper/combine":142}],209:[function(_dereq_,module,exports){
'use strict';
...
},{"../data/index":6,"../data/lexicon":7,"../fns":21,"../log":23,"../term":179}],217:[function(_dereq_,module,exports){
"use strict";
