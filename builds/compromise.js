...
},{"../package.json":2,"./log":17,"./text/build":111,"./world":210,"efrt":1}],5:[function(_dereq_,module,exports){
'use strict';
...
},{"../contraction/split":26}],34:[function(_dereq_,module,exports){
'use strict';
...
var findMultiWords = function findMultiWords(ts, i, world) {
  ...
  for (var add = 1; add <= 3; add++) {
    ...
    //perfect match here?
    if (want[str] === true) {
      var tag = world.lexicon[ts.terms[i].normal + ' ' + str];
...
Text.makeSubset = function (methods, find) {
  var Subset = function Subset(arr, world, reference) {
  ...
  var methods = {
    ...
    term: function term(n) {
      ...
      var list = this.list.map(function (ts) {
        ...
        return new Terms(arr, _this.world, _this.refText, _this.refTerms);
      });
...
var ContractionCl = function ContractionCl(arr, world, reference) {
...
var EndGrams = function EndGrams(arr, world, reference) {
...
var Gram = function Gram(arr, world, reference) {
  Terms.call(this, arr, world, reference);
...
var StartGrams = function StartGrams(arr, world, reference) {
  Ngrams.call(this, arr, world, reference);
};
