...
},{"../tags":175,"../term/methods/normalize/normalize":182,"./index":25,"./paths":38,"./tokenize":131}],25:[function(_dereq_,module,exports){
'use strict';
...
var foreach = ['toTitleCase', 'toUpperCase', 'toLowerCase', 'toCamelCase', 'hyphenate', 'dehyphenate', 'insertBefore', 'insertAfter', 'insertAt', 'replace', 'replaceWith', 'delete', 'lump'];
...
},{"../../../terms/index":195,"../../../terms/match/lib/syntax":201}],29:[function(_dereq_,module,exports){
'use strict';
//
...
},{"./indexes":31,"./offset":32,"./topk":33}],31:[function(_dereq_,module,exports){
'use strict';
...
},{"../data":6,"../fns":21,"../log":23,"../tags":175,"../terms":195}],39:[function(_dereq_,module,exports){
'use strict';
...
},{"../../../tries":237}],70:[function(_dereq_,module,exports){
'use strict';
...
},{"../../term":177,"./fix":136}],136:[function(_dereq_,module,exports){
'use strict';
...
},{"../../term":177}],137:[function(_dereq_,module,exports){
'use strict';
...
},{"../paths":145,"./verb_corrections":140}],140:[function(_dereq_,module,exports){
'use strict';
...
},{"./contraction":137,"./corrections":139,"./lumper/index":143,"./lumper/lexicon_lump":144,"./phrase":147,"./steps/01-punctuation_step":148,"./steps/02-lexicon_step":149,"./steps/03-capital_step":150,"./steps/04-web_step":151,"./steps/05-suffix_step":152,"./steps/06-neighbour_step":153,"./steps/07-noun_fallback":154,"./steps/08-date_step":155,"./steps/09-auxillary_step":156,"./steps/10-negation_step":157,"./steps/12-phrasal_step":158,"./steps/13-comma_step":159,"./steps/14-possessive_step":160,"./steps/15-value_step":161,"./steps/16-acronym_step":162,"./steps/17-emoji_step":163,"./steps/18-person_step":164,"./steps/19-quotation_step":165,"./steps/20-organization_step":166,"./steps/21-plural_step":167}],142:[function(_dereq_,module,exports){
'use strict';
...
},{"../paths":145,"./firstWord":142}],145:[function(_dereq_,module,exports){
'use strict';
...
},{"../data":6,"../data/lexicon":7,"../fns":21,"../log":23,"../tags":175,"../terms":195,"../tries":237}],146:[function(_dereq_,module,exports){
'use strict';
...
},{"../../tries":237,"../contraction/split":138,"../paths":145}],150:[function(_dereq_,module,exports){
'use strict';
...
var isYearSafer = function isYearSafer(num) {
...
},{"../../result/subset/verbs/methods/toInfinitive/index.js":127,"../paths":145}],159:[function(_dereq_,module,exports){
'use strict';
//-types of comma-use-
...
},{"../../result/subset/nouns/isPlural":71,"../paths":145}],168:[function(_dereq_,module,exports){
"use strict";
...
},{"../../paths":192,"dup":100}],190:[function(_dereq_,module,exports){
'use strict';
...
var unTagDeep = function unTagDeep(term, tag, reason) {
  if (!term || !tag) {
    return;
  }
  ...
  var methods = {
    ...
    match: function match(reg, verbose) {
      ...
      for (var t = 0; t < this.terms.length; t++) {
        ...
        var m = startHere(this, t, reg, verbose);
        if (m) {
          matches.push(m);
...
},{"../mutate":214}],204:[function(_dereq_,module,exports){
'use strict';
...
},{"../mutate":214}],205:[function(_dereq_,module,exports){
'use strict';
...
},{"../../../term":177,"../../paths":215}],207:[function(_dereq_,module,exports){
'use strict';
...
var lumpMethods = function lumpMethods(Terms) {
  ...
  var methods = {
    ...
    lump: function lump() {
      ...
      var tags = {};
      this.terms.forEach(function (t) {
        Object.keys(t.tag).forEach(function (tag) {
...
},{"../../mutate":214,"./combine":206}],208:[function(_dereq_,module,exports){
'use strict';
...
},{"../data/index":6,"../data/lexicon":7,"../fns":21,"../log":23,"../term":177}],216:[function(_dereq_,module,exports){
"use strict";
...
},{"./_packed/_adjectives":216,"./_packed/_adverbs":217,"./_packed/_airports":218,"./_packed/_cities":219,"./_packed/_countries":220,"./_packed/_demonyms":221,"./_packed/_expressions":222,"./_packed/_female":223,"./_packed/_firstnames":224,"./_packed/_holidays":225,"./_packed/_lastnames":226,"./_packed/_male":227,"./_packed/_nouns":228,"./_packed/_orgWords":229,"./_packed/_organizations":230,"./_packed/_phrasals":231,"./_packed/_prepositions":232,"./_packed/_professions":233,"./_packed/_sportsTeams":234,"./_packed/_uncountables":235,"./efrt-unpack":236}]},{},[22])(22)
});