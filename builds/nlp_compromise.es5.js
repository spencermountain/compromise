...
var assign=function assign(t,tag,reason){if(!mapping[tag]){console.log(t.text + '   ' + tag);}var P=mapping[tag] || Term;t = new P(t.text,tag);t.reason = reason;return t;};module.exports = assign;},{"./pos":27}],24:[function(require,module,exports){ //add a 'quiet' token for contractions so we can represent their grammar
...
var word_rules_pass=function word_rules_pass(terms){for(var _i12=0;_i12 < terms.length;_i12++) {for(var o=0;o < word_rules.length;o++) {if(terms[_i12].normal.length > 4 && terms[_i12].normal.match(word_rules[o].reg)){terms[_i12] = assign(terms[_i12],word_rules[o].pos,'rules_pass');break;}}}return terms;}; //turn [noun, noun..] into [noun..]
...
module.exports = syllables;},{}],62:[function(require,module,exports){'use strict';var _syllables=require('./syllables');var _americanize=require('./americanize');var _britishize=require('./britishize');var Term=(function(){function Term(str,tag){_classCallCheck(this,Term);this.changeTo(str);this.reason = '';var types={Determiner:'Determiner',Conjunction:'Conjunction',Preposition:'Preposition'};this.pos = types[tag] || '?';} // let t = new Term("synthesise")
