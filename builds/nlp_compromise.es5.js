...
module.exports = main;},{}],9:[function(require,module,exports){ //these are common person titles used in the lexicon and sentence segmentation methods
...
require('./data/verb_irregulars.js').forEach(function(o){Object.keys(o).forEach(function(k){if(k && verb_forms[k]){lexicon[o[k]] = verb_forms[k];}});});var orgs=require('./data/organisations.js');addArr(orgs.organisations,'Noun');addArr(orgs.suffixes,'Noun');var places=require('./data/places.js');addArr(places.countries,'Place');addArr(places.cities,'Place');addArr(require('./data/adjectives.js'),'Adjective');addObj(require('./data/convertables.js'));addArr(require('./data/abbreviations.js').abbreviations,'Abbreviation');addArr(require('./data/demonyms.js'),'Adjective');addArr(require('./data/honourifics.js'),'Honourific');addArr(require('./data/uncountables.js'),'Noun');addArr(require('./data/dates.js'),'Date');addArr(require('./data/numbers.js'),'Value'); //a little fancy
...
}}return terms;}};module.exports = handle_contractions;},{"../../term/term.js":60}],24:[function(require,module,exports){ //fancy combining/chunking of terms
'use strict';var pos=require('./pos');var shouldLump=function shouldLump(a,b){var lump_rules=[{condition:a.tag === 'Person' && b.tag === 'Honourific' || a.tag === 'Honourific' && b.tag === 'Person', //"John sr."
result:'Person'},{condition:a.tag === 'Person' && b.is_capital(), //'Person, Capital -> Person'
result:'Person'},{condition:a.tag === 'Date' && b.tag === 'Value', //June 4
result:'Date'}]; // {
//   condition: (), //
//   result: '',
// },
//
for(var _i11=0;_i11 < lump_rules.length;_i11++) {if(lump_rules[_i11].condition){return lump_rules[_i11].result;}}return false;};var lump=function lump(a,b,tag){var c=pos.classMapping[tag] || pos.Term;var t=new c(a.text + ' ' + b.text,tag);t.reason = 'lumped(' + t.reason + ')';return t;};var fancy_lumping=function fancy_lumping(terms){for(var _i12=1;_i12 < terms.length;_i12++) {var a=terms[_i12 - 1];var b=terms[_i12]; // Person, Capital -> "Person Capital"
var l=shouldLump(a,b);if(l !== false){terms[_i12] = lump(a,b,l);terms[_i12 - 1] = null;continue;}} //remove killed terms
terms = terms.filter(function(t){return t !== null;});return terms;};module.exports = fancy_lumping;},{"./pos":26}],25:[function(require,module,exports){module.exports = [{'before':['Determiner','?'],'after':['Determiner','Noun']},{'before':['Determiner','Adjective','Verb'],'after':['Noun','Noun','Noun']},{'before':['Determiner','Adverb','Adjective','?'],'after':['Determiner','Adverb','Adjective','Noun']},{'before':['Unknown','Determiner','Noun'],'after':['Verb','Determiner','Noun']}, //posessive hints
...
'VB':'Verb','VBD':'PastTense','VBF':'FutureTense','VBP':'Infinitive','VBG':'Gerund','VBN':'Verb','VBZ':'PresentTense','CP':'Copula','MD':'Modal','JJ':'Adjective','JJR':'Comparative','JJS':'Superlative','RB':'Adverb'};var classMapping={'Noun':Noun,'Honourific':Noun,'Acronym':Noun,'Plural':Noun,'Pronoun':Noun,'Verb':Verb,'PresentTense':Verb,'PastTense':Verb,'Infinitive':Verb,'Gerund':Verb,'Abbreviation':Verb,'Copula':Verb,'Modal':Verb,'Comparative':Adjective,'Superlative':Adjective,'Adjective':Adjective,'Determiner':Term,'Preposition':Term,'Expression':Term,'Conjunction':Term,'Posessive':Term,'Adverb':Adverb,'Value':Value,'Place':Place,'Person':Person,'Date':_Date};module.exports = {tag_mapping:tag_mapping,classMapping:classMapping,Term:Term,'Date':_Date,Value:Value,Verb:Verb,Person:Person,Place:Place,Organisation:Organisation,Adjective:Adjective,Adverb:Adverb,Noun:Noun};},{"../../term/adjective/adjective.js":30,"../../term/adverb/adverb.js":35,"../../term/noun/date/date.js":40,"../../term/noun/noun.js":45,"../../term/noun/organisation/organisation.js":47,"../../term/noun/person/person.js":49,"../../term/noun/place/place.js":51,"../../term/noun/value/value.js":58,"../../term/term.js":60,"../../term/verb/verb.js":67}],27:[function(require,module,exports){ //part-of-speech tagging
...
for(var _i13=1;_i13 < terms.length;_i13++) {if(terms[_i13].is_capital() || terms[_i13].is_acronym()){terms[_i13] = assign(terms[_i13],'Noun','capital_signal');}}return terms;}; //regex hints for words/suffixes
var word_rules_pass=function word_rules_pass(terms){for(var _i14=0;_i14 < terms.length;_i14++) {if(terms[_i14].tag !== '?'){continue;}for(var o=0;o < word_rules.length;o++) {if(terms[_i14].normal.length > 4 && terms[_i14].normal.match(word_rules[o].reg)){terms[_i14] = assign(terms[_i14],word_rules[o].pos,'rules_pass_' + o);break;}}}return terms;}; //turn [noun, noun..] into [noun..]
var chunk_neighbours=function chunk_neighbours(terms){var new_terms=[];var last=null;for(var _i15=0;_i15 < terms.length;_i15++) {var t=terms[_i15];if(last !== null && t.tag === last){new_terms[new_terms.length - 1].text += ' ' + t.text;new_terms[new_terms.length - 1].normalize();}else {new_terms.push(t);}last = t.tag;}return new_terms;}; //hints from the sentence grammar
var grammar_rules_pass=function grammar_rules_pass(s){var tags=s.tags();for(var _i16=0;_i16 < s.terms.length;_i16++) {var t=s.terms[_i16];for(var o=0;o < grammar_rules.length;o++) {var rule=grammar_rules[o]; //does this rule match
if(fns.sameArr(rule.before,tags.slice(_i16,_i16 + rule.before.length))){ //change before/after for each term
for(var c=0;c < rule.before.length;c++) {s.terms[_i16 + c] = assign(s.terms[_i16 + c],rule.after[c],'grammar_rule ' + c);}}}}return s.terms;};var noun_fallback=function noun_fallback(terms){for(var _i17=0;_i17 < terms.length;_i17++) {if(terms[_i17].tag === '?'){terms[_i17] = assign(terms[_i17],'Noun','fallback');}}return terms;}; //turn nouns into person/place
var specific_pos=function specific_pos(terms){for(var _i18=0;_i18 < terms.length;_i18++) {var t=terms[_i18];if(t instanceof pos.Noun){if(t.is_person()){terms[_i18] = assign(t,'Person');}if(t.is_place()){terms[_i18] = assign(t,'Place');}if(t.is_value()){terms[_i18] = assign(t,'Value');}if(t.is_date()){terms[_i18] = assign(t,'Date');}}}return terms;};var tagger=function tagger(s){ //word-level rules
s.terms = capital_signals(s.terms);s.terms = contractions(s.terms);s.terms = lexicon_pass(s.terms);s.terms = word_rules_pass(s.terms); //repeat these steps a couple times, to wiggle-out the grammar
for(var _i19=0;_i19 < 1;_i19++) {s.terms = grammar_rules_pass(s);s.terms = chunk_neighbours(s.terms);s.terms = noun_fallback(s.terms);s.terms = specific_pos(s.terms);s.terms = fancy_lumping(s.terms);}return s.terms;};module.exports = tagger;},{"../../fns":20,"../../lexicon.js":22,"./contractions":23,"./fancy_lumping":24,"./grammar_rules":25,"./pos":26,"./word_rules":28}],28:[function(require,module,exports){var tag_mapping=require('./pos.js').tag_mapping; //regex patterns and parts of speech],
...
module.exports = extractDates;},{"sugar-date":2}],43:[function(require,module,exports){'use strict';var irregulars=require('../../data/irregular_nouns'); //similar to plural/singularize rules, but not the same
...
for(var _i33=0;_i33 < irregulars.length;_i33++) {if(irregulars[_i33][1] === str){return true;}if(irregulars[_i33][0] === str){return false;}}for(var _i34=0;_i34 < plural_indicators.length;_i34++) {if(str.match(plural_indicators[_i34])){return true;}}for(var _i35=0;_i35 < singular_indicators.length;_i35++) {if(str.match(singular_indicators[_i35])){return false;}} // some 'looks pretty plural' rules
...
module.exports = is_plural;},{"../../data/irregular_nouns":10}],44:[function(require,module,exports){ //uncountables are words that shouldn't ever inflect, for metaphysical reasons, like 'peace'
...
},{key:"is_person",value:function is_person(){return _is_person(this.normal);}},{key:"is_organisation",value:function is_organisation(){return _is_organisation(this.normal,this.text);}},{key:"is_date",value:function is_date(){return _is_date(this.normal);}},{key:"is_value",value:function is_value(){return _is_value(this.normal);}},{key:"is_place",value:function is_place(){return _is_place(this.normal);}}]);return Noun;})(Term);module.exports = Noun;},{"../term.js":60,"./article.js":39,"./date/is_date.js":41,"./is_plural.js":43,"./is_uncountable.js":44,"./organisation/is_organisation.js":46,"./person/is_person.js":48,"./place/is_place.js":50,"./pluralize.js":52,"./singularize.js":53,"./value/is_value.js":54}],46:[function(require,module,exports){'use strict';var firstnames=require('../../../data/firstnames');var abbreviations=require('../../../data/abbreviations');var org_data=require('../../../data/organisations'); //words like 'co' and ltd
...
},{"../../../data/abbreviations":3,"../../../data/firstnames":8,"../../../data/organisations":14}],47:[function(require,module,exports){'use strict';var Noun=require('../noun.js');var Organisation=(function(_Noun2){_inherits(Organisation,_Noun2);function Organisation(str,tag){_classCallCheck(this,Organisation);_get(Object.getPrototypeOf(Organisation.prototype),"constructor",this).call(this,str);this.tag = tag;this.pos['Organisation'] = true;}return Organisation;})(Noun);module.exports = Organisation;},{"../noun.js":45}],48:[function(require,module,exports){'use strict';var firstnames=require('../../../data/firstnames');var honourifics=require('../../../data/honourifics');honourifics = honourifics.reduce(function(h,s){h[s] = true;return h;},{});var is_person=function is_person(str){if(str === 'he' || str === 'she' || firstnames[str]){return true;}var words=str.split(' ');if(words.length > 1){var first=words[0];if(honourifics[first] || firstnames[first]){return true;}}return false;};module.exports = is_person;},{"../../../data/firstnames":8,"../../../data/honourifics":9}],49:[function(require,module,exports){ // not all cultures use the firstname-lastname practice. this does make some assumptions.
...
}}]);return Person;})(Noun);module.exports = Person;},{"../../../data/firstnames":8,"../../../data/honourifics":9,"../noun.js":45}],50:[function(require,module,exports){'use strict';var places=require('../../../data/places');var abbreviations=require('../../../data/abbreviations'); //add Country names
...
for(var _i37=0;_i37 < pluralize_rules.length;_i37++) {if(str.match(pluralize_rules[_i37].reg)){return str.replace(pluralize_rules[_i37].reg,pluralize_rules[_i37].repl);}}}; // console.log(pluralize('gas') === "gases")
...
for(var _i38=0;_i38 < singularize_rules.length;_i38++) {if(str.match(singularize_rules[_i38].reg)){return str.replace(singularize_rules[_i38].reg,singularize_rules[_i38].repl);}}return str;}; // console.log(singularize('gases') === "gas")
...
var mults=[{reg:/^(minus|negative)[\s\-]/i,mult:-1},{reg:/^(a\s)?half[\s\-](of\s)?/i,mult:0.5},{reg:/^(a\s)?quarter[\s\-]/i,mult:0.25}];for(var _i40=0;_i40 < mults.length;_i40++) {if(s.match(mults[_i40].reg)){global_multiplier = mults[_i40].mult;s = s.replace(mults[_i40].reg,'');break;}} //do each word in turn..
var words=s.toString().split(/[\s\-]+/);var w=undefined,x=undefined;var current_sum=0;var local_multiplier=1;var decimal_mode=false;for(var _i41=0;_i41 < words.length;_i41++) {w = words[_i41]; //skip 'and' eg. five hundred and twelve
...
str = str.replace(/[\u201C\u201D\u201E\u201F\u2033\u2036]+/g,'"');if(!str.match(/[a-z0-9]/i)){return '';}this.normal = str;return this.normal;}},{key:"americanize",value:function americanize(){return _americanize(this.normal);}},{key:"britishize",value:function britishize(){return _britishize(this.normal);}},{key:"syllables",value:function syllables(){return _syllables(this.normal);}}]);return Term;})();module.exports = Term;},{"./americanize":37,"./britishize":38,"./syllables":59}],61:[function(require,module,exports){ //turn a verb into its other grammatical forms.
...
var obj={};var l=verb_irregulars.length;for(var _i45=0;_i45 < l;_i45++) {var x=verb_irregulars[_i45];if(verb === x.present || verb === x.gerund || verb === x.past || verb === x.infinitive){obj = JSON.parse(JSON.stringify(verb_irregulars[_i45])); // object 'clone' hack, to avoid mem leak
...
l = verb_rules[predicted].length;for(var _i46=0;_i46 < l;_i46++) {var r=verb_rules[predicted][_i46];if(w.match(r.reg)){obj[predicted] = w;var keys=Object.keys(r.repl);for(var o=0;o < keys.length;o++) {if(keys[o] === predicted){obj[keys[o]] = w;}else {obj[keys[o]] = w.replace(r.reg,r.repl[keys[o]]);}}return fufill(obj);}} //produce a generic transformation
...
},{"../../../data/verb_irregulars":18,"./predict_form.js":62,"./to_actor":64,"./verb_rules":65}],62:[function(require,module,exports){'use strict'; //this method is used to predict which current conjugation a verb is
...
var predict=function predict(w){var arr=Object.keys(suffix_rules);for(var _i47=0;_i47 < arr.length;_i47++) {if(fns.endsWith(w,arr[_i47])){return suffix_rules[arr[_i47]];}}return 'infinitive';};module.exports = predict;},{"../../../fns.js":20,"./suffix_rules":63}],63:[function(require,module,exports){'use strict'; //generated from test data
var compact={'gerund':['ing'],'infinitive':['ate','ize','tion','rify','ress','ify','age','nce','ect','ise','ine','ish','ace','ash','ure','tch','end','ack','and','ute','ade','ock','ite','ase','ose','use','ive','int','nge','lay','est','ain','ant','eed','er','le'],'past':['ed','lt','nt','pt','ew','ld'],'present':['rks','cks','nks','ngs','mps','tes','zes','ers','les','acks','ends','ands','ocks','lays','eads','lls','els','ils','ows','nds','ays','ams','ars','ops','ffs','als','urs','lds','ews','ips','es','ts','ns','s']};var suffix_rules={};var keys=Object.keys(compact);var l=keys.length;var l2=undefined;for(var _i48=0;_i48 < l;_i48++) {l2 = compact[keys[_i48]].length;for(var o=0;o < l2;o++) {suffix_rules[compact[keys[_i48]][o]] = keys[_i48];}}module.exports = suffix_rules;},{}],64:[function(require,module,exports){ //somone who does this present-tense verb
//turn 'walk' into 'walker'
'use strict';var actor=function actor(str){str = str || '';var irregulars={'tie':'tier','dream':'dreamer','sail':'sailer','run':'runner','rub':'rubber','begin':'beginner','win':'winner','claim':'claimant','deal':'dealer','spin':'spinner'};var dont={'aid':1,'fail':1,'appear':1,'happen':1,'seem':1,'try':1,'say':1,'marry':1,'be':1,'forbid':1,'understand':1,'bet':1};var transforms=[{'reg':/e$/i,'repl':'er'},{'reg':/([aeiou])([mlgp])$/i,'repl':'$1$2$2er'},{'reg':/([rlf])y$/i,'repl':'$1ier'},{'reg':/^(.?.[aeiou])t$/i,'repl':'$1tter'}];if(dont.hasOwnProperty(str)){return null;}if(irregulars.hasOwnProperty(str)){return irregulars[str];}for(var _i49=0;_i49 < transforms.length;_i49++) {if(str.match(transforms[_i49].reg)){return str.replace(transforms[_i49].reg,transforms[_i49].repl);}}return str + 'er';}; // console.log(verb_to_actor('set'))
// console.log(verb_to_actor('sweep'))
// console.log(verb_to_actor('watch'))
module.exports = actor;},{}],65:[function(require,module,exports){ // regex rules for each part of speech that convert it to all other parts of speech.
...
},{}],66:[function(require,module,exports){'use strict'; //recieves a verb object, and returns a negated string
...
},{key:"isNegative",value:function isNegative(){var str=this.normal;if(str.match(/(n't|\bnot\b)/)){return true;}return false;}},{key:"negate",value:function negate(){if(this.isNegative()){return this.text;}this.changeTo(_negate(this));return this.text;}}]);return Verb;})(Term);module.exports = Verb;},{"../term.js":60,"./conjugate/conjugate.js":61,"./conjugate/predict_form.js":62,"./negate.js":66}],68:[function(require,module,exports){'use strict'; //split a string into all possible parts
...
for(var _i50=1;_i50 <= max_size;_i50++) {keys.push({});} // Create a hash for counting..
var textlen=terms.length;for(var _i51=0;_i51 < textlen;_i51++) {var s=terms[_i51];keys[1][s] = (keys[1][s] || 0) + 1;for(var j=2;j <= max_size;j++) {if(_i51 + j <= textlen){s += ' ' + terms[_i51 + j - 1];keys[j][s] = (keys[j][s] || 0) + 1;}else {break;}}} // map the hash to an array for sorting
for(var k=1;k < max_size;k++) {results[k] = [];var key=keys[k];var words=Object.keys(keys[k]);for(var _i52=0;_i52 < words.length;_i52++) {var word=words[_i52];if(key[word] >= min_count){results[k].push({'word':word,'count':key[word],'size':k});}}} //post-process + sort
...
module.exports = ngram;},{"../fns.js":20}],69:[function(require,module,exports){ //(Rule-based sentence boundary segmentation) - chop given text into its proper sentences.
...
var chunks_length=chunks.length;for(var _i53=0;_i53 < chunks_length;_i53++) {if(chunks[_i53]){ //trim whitespace
chunks[_i53] = chunks[_i53].replace(/^\s+|\s+$/g,''); //should this chunk be combined with the next one?
if(chunks[_i53 + 1] && chunks[_i53].match(abbrev_reg) || chunks[_i53].match(acronym_reg) || chunks[_i53].match(elipses_reg)){chunks[_i53 + 1] = ((chunks[_i53] || '') + ' ' + (chunks[_i53 + 1] || '')).replace(/ +/g,' ');}else if(chunks[_i53] && chunks[_i53].length > 0){ //this chunk is a proper sentence..
sentences.push(chunks[_i53]);chunks[_i53] = '';}}} //if we never got a sentence, return the given text
if(sentences.length === 0){return [text];}return sentences;};module.exports = sentence_parser;},{"../data/abbreviations":3}],70:[function(require,module,exports){'use strict';var sentence_parser=require('./sentence_parser.js');var Sentence=require('../sentence/sentence.js');var _ngram=require('./ngram.js');var fns=require('../fns.js'); //a text object is a series of sentences, along with the generic methods for transforming them
