...
module.exports = main;},{}],8:[function(require,module,exports){var grand_mapping={ //nouns
...
'VB':'Verb','VBD':'PastTense','VBF':'FutureTense','VBP':'Infinitive','VBG':'Gerund','VBN':'Verb','VBZ':'PresentTense','CP':'Copula','MD':'Modal','JJ':'Adjective','JJR':'Comparative','JJS':'Superlative','RB':'Adverb'};module.exports = grand_mapping;},{}],9:[function(require,module,exports){ //these are common person titles used in the lexicon and sentence segmentation methods
//they are also used to identify that a noun is a person
module.exports = [ //honourifics
'jr','mr','mrs','ms','dr','prof','sr','sen','corp','rep','gov','atty','supt','det','rev','col','gen','lt','cmdr','adm','capt','sgt','cpl','maj','miss','misses','mister','sir','esq','mstr','phd','adj','adv','asst','bldg','brig','comdr','hon','messrs','mlle','mme','op','ord','pvt','reps','res','sens','sfc','surg'];},{}],10:[function(require,module,exports){ //nouns with irregular plural/singular forms
//used in noun.inflect, and also in the lexicon.
//compressed with '_' to reduce some redundancy.
'use strict';var main=[['child','_ren'],['person','people'],['leaf','leaves'],['database','_s'],['quiz','_zes'],['child','_ren'],['stomach','_s'],['sex','_es'],['move','_s'],['shoe','_s'],['goose','geese'],['phenomenon','phenomena'],['barracks','_'],['deer','_'],['syllabus','syllabi'],['index','indices'],['appendix','appendices'],['criterion','criteria'],['man','men'],['sex','_es'],['rodeo','_s'],['epoch','_s'],['zero','_s'],['avocado','_s'],['halo','_s'],['tornado','_s'],['tuxedo','_s'],['sombrero','_s'],['addendum','addenda'],['alga','_e'],['alumna','_e'],['alumnus','alumni'],['bacillus','bacilli'],['cactus','cacti'],['beau','_x'],['château','_x'],['chateau','_x'],['tableau','_x'],['corpus','corpora'],['curriculum','curricula'],['echo','_es'],['embargo','_es'],['foot','feet'],['genus','genera'],['hippopotamus','hippopotami'],['larva','_e'],['libretto','libretti'],['loaf','loaves'],['matrix','matrices'],['memorandum','memoranda'],['mosquito','_es'],['opus','opera'],['ovum','ova'],['ox','_en'],['radius','radii'],['referendum','referenda'],['thief','thieves'],['tooth','teeth']];main = main.map(function(a){a[1] = a[1].replace('_',a[0]);return a;});module.exports = main;},{}],11:[function(require,module,exports){'use strict';var misc={'etc':'FW', //foreign words
...
},{}],19:[function(require,module,exports){ //most-frequent non-irregular verbs, to be conjugated for the lexicon
//this list is the seed, from which various forms are conjugated
...
module.exports = lexicon;},{"./data/abbreviations.js":3,"./data/adjectives.js":4,"./data/dates.js":5,"./data/demonyms.js":6,"./data/firstnames.js":7,"./data/grand_mapping.js":8,"./data/honourifics.js":9,"./data/irregular_nouns.js":10,"./data/misc.js":11,"./data/multiples.js":12,"./data/numbers.js":13,"./data/organisations.js":14,"./data/phrasal_verbs.js":15,"./data/places.js":16,"./data/uncountables.js":17,"./data/verb_irregulars.js":18,"./data/verbs.js":19,"./fns.js":20,"./term/verb/conjugate/conjugate.js":63}],23:[function(require,module,exports){'use strict';var pos=require('./pos');var Noun=pos.Noun;var Verb=pos.Verb;var mapping={'Noun':Noun,'Honourific':Noun,'Acronym':Noun,'Plural':Noun,'Pronoun':Noun,'Name':Noun,'Verb':Verb,'PresentTense':Verb,'PastTense':Verb,'Infinitive':Verb,'Gerund':Verb,'Abbreviation':Verb,'Copula':Verb,'Modal':Verb,'Comparative':pos.Adjective,'Superlative':pos.Adjective,'Adjective':pos.Adjective,'Determiner':pos.Term,'Preposition':pos.Term,'Expression':pos.Term,'Conjunction':pos.Term,'Posessive':pos.Term,'Adverb':pos.Adverb,'Value':pos.Value,'Place':pos.Place,'Person':pos.Person,'Date':pos._Date}; //swap the Term object with a proper Pos class
var assign=function assign(t,tag,reason){var P=mapping[tag] || pos.Term;t = new P(t.text,tag);t.reason = reason;return t;};module.exports = assign;},{"./pos":27}],24:[function(require,module,exports){ //add a 'quiet' token for contractions so we can represent their grammar
'use strict';var Term=require('../../term/term.js');var contractions={'i\'d':['i','would'],'she\'d':['she','would'],'he\'d':['he','would'],'they\'d':['they','would'],'we\'d':['we','would'],'i\'ll':['i','will'],'she\'ll':['she','will'],'he\'ll':['he','will'],'they\'ll':['they','will'],'we\'ll':['we','will'],'i\'ve':['i','have'],'they\'ve':['they','have'],'we\'ve':['we','have'],'should\'ve':['should','have'],'would\'ve':['would','have'],'could\'ve':['could','have'],'must\'ve':['must','have'],'i\'m':['i','am'],'we\'re':['we','are'],'they\'re':['they','are'],'cannot':['can','not']};var handle_contractions=function handle_contractions(_x4){var _again2=true;_function2: while(_again2) {var terms=_x4;_i10 = t = split = fixup = undefined;_again2 = false;for(var _i10=0;_i10 < terms.length;_i10++) {var t=terms[_i10];if(contractions[t.normal] !== undefined){var split=contractions[t.normal];var fixup=[].concat(terms.slice(0,_i10),[new Term(split[0])],[new Term(split[1])],terms.slice(_i10 + 1,terms.length));_x4 = fixup;_again2 = true;continue _function2; //recursive
}}return terms;}};module.exports = handle_contractions;},{"../../term/term.js":62}],25:[function(require,module,exports){module.exports = [{'before':['Determiner','?'],'after':['Determiner','Noun']},{'before':['Determiner','Adjective','Verb'],'after':['Noun','Noun','Noun']},{'before':['Determiner','Adverb','Adjective','?'],'after':['Determiner','Adverb','Adjective','Noun']},{'before':['Unknown','Determiner','Noun'],'after':['Verb','Determiner','Noun']}, //posessive hints
...
{'before':['Modal','Value'],'after':['Modal','Verb']},{'before':['Adverb','Value'],'after':['Adverb','Verb']}];},{}],26:[function(require,module,exports){'use strict';var assign=require('./assign');var lexicon=require('../../lexicon.js'); //consult lexicon for this known-word
...
if(t.normal.match(/-/)){var sides=t.normal.split('-');if(lexicon[sides[0]]){return assign(t,lexicon[sides[0]],'lexicon_dash');}if(lexicon[sides[1]]){return assign(t,lexicon[sides[1]],'lexicon_dash');}}return t;});};module.exports = lexicon_pass;},{"../../lexicon.js":22,"./assign":23}],27:[function(require,module,exports){exports.Term = require('../../term/term.js');exports.Verb = require('../../term/verb/verb.js');exports.Adverb = require('../../term/adverb/adverb.js');exports.Adjective = require('../../term/adjective/adjective.js');exports.Noun = require('../../term/noun/noun.js');exports.Person = require('../../term/noun/person/person.js');exports.Place = require('../../term/noun/place/place.js');exports.Value = require('../../term/noun/value/value.js');exports._Date = require('../../term/noun/date/date.js');},{"../../term/adjective/adjective.js":31,"../../term/adverb/adverb.js":37,"../../term/noun/date/date.js":42,"../../term/noun/noun.js":47,"../../term/noun/person/person.js":51,"../../term/noun/place/place.js":53,"../../term/noun/value/value.js":60,"../../term/term.js":62,"../../term/verb/verb.js":69}],28:[function(require,module,exports){ //part-of-speech tagging
'use strict';var lexicon_pass=require('./lexicon_pass');var contractions=require('./contractions');var assign=require('./assign');var word_rules=require('./word_rules');var grammar_rules=require('./grammar_rules');var fns=require('../../fns');var pos=require('./pos'); //set POS for capitalised words
...
for(var _i11=1;_i11 < terms.length;_i11++) {if(terms[_i11].is_capital() || terms[_i11].is_acronym()){terms[_i11] = assign(terms[_i11],'Noun','capital_signal');}}return terms;}; //regex hints for words/suffixes
var word_rules_pass=function word_rules_pass(terms){for(var _i12=0;_i12 < terms.length;_i12++) {if(terms[_i12].tag !== '?'){continue;}for(var o=0;o < word_rules.length;o++) {if(terms[_i12].normal.length > 4 && terms[_i12].normal.match(word_rules[o].reg)){terms[_i12] = assign(terms[_i12],word_rules[o].pos,'rules_pass_' + o);break;}}}return terms;}; //turn [noun, noun..] into [noun..]
var chunk_neighbours=function chunk_neighbours(terms){var new_terms=[];var last=null;for(var _i13=0;_i13 < terms.length;_i13++) {var t=terms[_i13];if(last !== null && t.pos === last){new_terms[new_terms.length - 1].text += ' ' + t.text;new_terms[new_terms.length - 1].normalize();}else {new_terms.push(t);}last = t.pos;}return new_terms;}; //hints from the sentence grammar
var grammar_rules_pass=function grammar_rules_pass(s){var tags=s.tags();for(var _i14=0;_i14 < s.terms.length;_i14++) {var t=s.terms[_i14];for(var o=0;o < grammar_rules.length;o++) {var rule=grammar_rules[o]; //does this rule match
if(fns.sameArr(rule.before,tags.slice(_i14,_i14 + rule.before.length))){ //change before/after for each term
for(var c=0;c < rule.before.length;c++) {s.terms[_i14 + c] = assign(s.terms[_i14 + c],rule.after[c],'grammar_rule ' + c);}}}}return s.terms;};var noun_fallback=function noun_fallback(terms){for(var _i15=0;_i15 < terms.length;_i15++) {if(terms[_i15].pos === '?'){terms[_i15] = assign(terms[_i15],'Noun','fallback');}}return terms;}; //turn nouns into person/place
var specific_pos=function specific_pos(terms){for(var _i16=0;_i16 < terms.length;_i16++) {var t=terms[_i16];if(t instanceof pos.Noun){if(t.is_person()){terms[_i16] = assign(t,'Person');}if(t.is_place()){terms[_i16] = assign(t,'Place');}if(t.is_value()){terms[_i16] = assign(t,'Value');}if(t.is_date()){terms[_i16] = assign(t,'Date');}}}return terms;};var tagger=function tagger(s){s.terms = capital_signals(s.terms);s.terms = contractions(s.terms);s.terms = lexicon_pass(s.terms);s.terms = word_rules_pass(s.terms); //repeat these two
s.terms = grammar_rules_pass(s);s.terms = chunk_neighbours(s.terms);s.terms = noun_fallback(s.terms); //turns the general pos into specific ones
s.terms = specific_pos(s.terms);return s.terms;};module.exports = tagger;},{"../../fns":20,"./assign":23,"./contractions":24,"./grammar_rules":25,"./lexicon_pass":26,"./pos":27,"./word_rules":29}],29:[function(require,module,exports){var grand_mapping=require('../../data/grand_mapping.js'); //regex patterns and parts of speech],
...
for(var _i29=0;_i29 < a_regexs.length;_i29++) {if(str.match(a_regexs[_i29])){return 'a';}} //basic vowel-startings
if(str.match(/^[aeiou]/i)){return 'an';}return 'a';}; // console.log(indefinite_article("wolf") === "a")
module.exports = indefinite_article;},{}],42:[function(require,module,exports){'use strict';var Noun=require('../noun.js');var _parse=require('./parse.js');var Date=(function(_Noun){_inherits(Date,_Noun);function Date(str,tag){_classCallCheck(this,Date);_get(Object.getPrototypeOf(Date.prototype),"constructor",this).call(this,str);this.tag = tag;this.pos = 'Date';this.date = null;this.parse();}_createClass(Date,[{key:"parse",value:function parse(){var dates=_parse(this.text) || [];if(dates.length){this.date = dates[0].Date;}}}]);return Date;})(Noun);module.exports = Date;},{"../noun.js":47,"./parse.js":44}],43:[function(require,module,exports){'use strict';var dates=require('../../../data/dates');var is_date=function is_date(str){var day_reg='(\\b' + dates.join('\\b|\\b') + '\\b)';day_reg = new RegExp(day_reg,'i');var times_reg=/1?[0-9]:[0-9]{2}/;if(str.match(day_reg) || str.match(times_reg)){return true;}return false;};module.exports = is_date; // console.log(is_date('january fifth, 2015'));
},{"../../../data/dates":5}],44:[function(require,module,exports){require('sugar-date'); // var data = require("./old/lexdates").dates;
...
module.exports = extractDates;},{"sugar-date":2}],45:[function(require,module,exports){'use strict';var irregulars=require('../../data/irregular_nouns'); //similar to plural/singularize rules, but not the same
...
for(var _i30=0;_i30 < irregulars.length;_i30++) {if(irregulars[_i30][1] === str){return true;}if(irregulars[_i30][0] === str){return false;}}for(var _i31=0;_i31 < plural_indicators.length;_i31++) {if(str.match(plural_indicators[_i31])){return true;}}for(var _i32=0;_i32 < singular_indicators.length;_i32++) {if(str.match(singular_indicators[_i32])){return false;}} // some 'looks pretty plural' rules
...
module.exports = is_plural;},{"../../data/irregular_nouns":10}],46:[function(require,module,exports){ //uncountables are words that shouldn't ever inflect, for metaphysical reasons, like 'peace'
...
module.exports = is_uncountable;},{"../../data/uncountables.js":17}],47:[function(require,module,exports){'use strict';var Term=require('../term.js');var _article=require('./article.js');var _is_plural=require('./is_plural.js');var _is_place=require('./place/is_place.js');var _is_person=require('./person/is_person.js');var _is_value=require('./value/is_value.js');var _is_date=require('./date/is_date.js');var _is_organisation=require('./organisation/is_organisation.js');var _singularize=require('./singularize.js');var _pluralize=require('./pluralize.js');var _is_uncountable=require('./is_uncountable.js');var Noun=(function(_Term3){_inherits(Noun,_Term3);function Noun(str,tag){_classCallCheck(this,Noun);_get(Object.getPrototypeOf(Noun.prototype),"constructor",this).call(this,str);this.tag = tag;this.pos = 'Noun';} // let t = new Noun("forks")
...
},{key:"is_person",value:function is_person(){return _is_person(this.normal);}},{key:"is_organisation",value:function is_organisation(){return _is_organisation(this.normal,this.text);}},{key:"is_date",value:function is_date(){return _is_date(this.normal);}},{key:"is_value",value:function is_value(){return _is_value(this.normal);}},{key:"is_place",value:function is_place(){return _is_place(this.normal);}}]);return Noun;})(Term);module.exports = Noun;},{"../term.js":62,"./article.js":41,"./date/is_date.js":43,"./is_plural.js":45,"./is_uncountable.js":46,"./organisation/is_organisation.js":48,"./person/is_person.js":50,"./place/is_place.js":52,"./pluralize.js":54,"./singularize.js":55,"./value/is_value.js":56}],48:[function(require,module,exports){'use strict';var firstnames=require('../../../data/firstnames');var abbreviations=require('../../../data/abbreviations');var org_data=require('../../../data/organisations'); //words like 'co' and ltd
...
if(str.match(/ (&|of) /)){return true;} // eg pets.com
if(str.match(/[a-z]{3}\.(com|net|org|biz)/)){ //not a perfect url regex, but a "org.com"
return true;}var words=str.split(' ');var last=words[words.length - 1];if(org_suffix[last]){return true;}return false;};module.exports = is_organisation; // console.log(is_organisation('4 hundred and ten'));
},{"../../../data/abbreviations":3,"../../../data/firstnames":7,"../../../data/organisations":14}],49:[function(require,module,exports){'use strict';var Noun=require('../noun.js');var Organisation=(function(_Noun2){_inherits(Organisation,_Noun2);function Organisation(str,tag){_classCallCheck(this,Organisation);_get(Object.getPrototypeOf(Organisation.prototype),"constructor",this).call(this,str);this.tag = tag;this.pos = 'Organisation';}return Organisation;})(Noun);module.exports = Organisation;},{"../noun.js":47}],50:[function(require,module,exports){'use strict';var firstnames=require('../../../data/firstnames');var honourifics=require('../../../data/honourifics');honourifics = honourifics.reduce(function(h,s){h[s] = true;return h;},{});var is_person=function is_person(str){var words=str.split(' ');var first=words[0];if(str === 'he' || str === 'she'){return true;}if(honourifics[first] || firstnames[first]){return true;}return false;};module.exports = is_person;},{"../../../data/firstnames":7,"../../../data/honourifics":9}],51:[function(require,module,exports){ // not all cultures use the firstname-lastname practice. this does make some assumptions.
'use strict';var Noun=require('../noun.js');var firstnames=require('../../../data/firstnames');var honourifics=require('../../../data/honourifics');honourifics = honourifics.reduce(function(h,s){h[s] = true;return h;},{});var Person=(function(_Noun3){_inherits(Person,_Noun3);function Person(str,tag){_classCallCheck(this,Person);_get(Object.getPrototypeOf(Person.prototype),"constructor",this).call(this,str);this.tag = tag;this.pos = 'Person';this.honourific = null;this.firstName = null;this.middleName = null;this.lastName = null;this.parse();} //turn a multi-word string into [first, middle, last, honourific]
...
if(words[words.length - 1]){this.lastName = words[words.length - 1];words = words.slice(0,words.length - 1);}this.middleName = words.join(' ');}},{key:"gender",value:function gender(){if(this.normal === 'he'){return 'Male';}if(this.normal === 'she'){return 'Female';}if(!this.firstName){return null;}if(firstnames[this.firstName] === 'm'){return 'Male';}if(firstnames[this.firstName] === 'f'){return 'Female';}if(this.firstName.match(/.(i|ee|[a|e]y|a)$/)){ //this is almost-always true
...
}}]);return Person;})(Noun);module.exports = Person;},{"../../../data/firstnames":7,"../../../data/honourifics":9,"../noun.js":47}],52:[function(require,module,exports){'use strict';var places=require('../../../data/places');var abbreviations=require('../../../data/abbreviations'); //add Country names
...
for(var _i34=0;_i34 < pluralize_rules.length;_i34++) {if(str.match(pluralize_rules[_i34].reg)){return str.replace(pluralize_rules[_i34].reg,pluralize_rules[_i34].repl);}}}; // console.log(pluralize('gas') === "gases")
...
for(var _i35=0;_i35 < singularize_rules.length;_i35++) {if(str.match(singularize_rules[_i35].reg)){return str.replace(singularize_rules[_i35].reg,singularize_rules[_i35].repl);}}return str;}; // console.log(singularize('gases') === "gas")
...
var mults=[{reg:/^(minus|negative)[\s\-]/i,mult:-1},{reg:/^(a\s)?half[\s\-](of\s)?/i,mult:0.5},{reg:/^(a\s)?quarter[\s\-]/i,mult:0.25}];for(var _i37=0;_i37 < mults.length;_i37++) {if(s.match(mults[_i37].reg)){global_multiplier = mults[_i37].mult;s = s.replace(mults[_i37].reg,'');break;}} //do each word in turn..
var words=s.toString().split(/[\s\-]+/);var w=undefined,x=undefined;var current_sum=0;var local_multiplier=1;var decimal_mode=false;for(var _i38=0;_i38 < words.length;_i38++) {w = words[_i38]; //skip 'and' eg. five hundred and twelve
...
module.exports = syllables;},{}],62:[function(require,module,exports){'use strict';var _syllables=require('./syllables');var _americanize=require('./americanize');var _britishize=require('./britishize');var Term=(function(){function Term(str,tag){_classCallCheck(this,Term);this.changeTo(str);this.reason = '';var types={Determiner:'Determiner',Conjunction:'Conjunction',Preposition:'Preposition'};this.pos = '?';this.tag = types[tag] || '?';} // let t = new Term("synthesise")
...
var fallback=function fallback(w){var infinitive=undefined;if(w.length > 4){infinitive = w.replace(/ed$/,'');}else {infinitive = w.replace(/d$/,'');}var present=undefined,past=undefined,gerund=undefined,actor=undefined;if(w.match(/[^aeiou]$/)){gerund = w + 'ing';past = w + 'ed';if(w.match(/ss$/)){present = w + 'es'; //'passes'
}else {present = w + 's';}actor = verb_to_actor(infinitive);}else {gerund = w.replace(/[aeiou]$/,'ing');past = w.replace(/[aeiou]$/,'ed');present = w.replace(/[aeiou]$/,'es');actor = verb_to_actor(infinitive);}return {infinitive:infinitive,present:present,past:past,gerund:gerund,actor:actor,future:'will ' + infinitive};}; //make sure object has all forms
...
delete result['actor'];Object.keys(result).forEach(function(k){if(result[k]){result[k] += ' ' + particle;}});return {v:result};})();if(typeof _ret2 === "object")return _ret2.v;} //for pluperfect ('had tried') remove 'had' and call it past-tense
...
var obj={};var l=verb_irregulars.length;for(var _i42=0;_i42 < l;_i42++) {var x=verb_irregulars[_i42];if(verb === x.present || verb === x.gerund || verb === x.past || verb === x.infinitive){obj = JSON.parse(JSON.stringify(verb_irregulars[_i42])); // object 'clone' hack, to avoid mem leak
...
l = verb_rules[predicted].length;for(var _i43=0;_i43 < l;_i43++) {var r=verb_rules[predicted][_i43];if(w.match(r.reg)){obj[predicted] = w;var keys=Object.keys(r.repl);for(var o=0;o < keys.length;o++) {if(keys[o] === predicted){obj[keys[o]] = w;}else {obj[keys[o]] = w.replace(r.reg,r.repl[keys[o]]);}}return fufill(obj);}} //produce a generic transformation
...
},{"../../../data/verb_irregulars":18,"./predict_form.js":64,"./to_actor":66,"./verb_rules":67}],64:[function(require,module,exports){'use strict'; //this method is used to predict which current conjugation a verb is
...
},{key:"isNegative",value:function isNegative(){var str=this.normal;if(str.match(/(n't|\bnot\b)/)){return true;}return false;}},{key:"negate",value:function negate(){if(this.isNegative()){return this.text;}this.changeTo(_negate(this));return this.text;}}]);return Verb;})(Term);module.exports = Verb;},{"../term.js":62,"./conjugate/conjugate.js":63,"./conjugate/predict_form.js":64,"./negate.js":68}],70:[function(require,module,exports){'use strict'; //split a string into all possible parts
...
for(var _i47=1;_i47 <= max_size;_i47++) {keys.push({});} // Create a hash for counting..
var textlen=terms.length;for(var _i48=0;_i48 < textlen;_i48++) {var s=terms[_i48];keys[1][s] = (keys[1][s] || 0) + 1;for(var j=2;j <= max_size;j++) {if(_i48 + j <= textlen){s += ' ' + terms[_i48 + j - 1];keys[j][s] = (keys[j][s] || 0) + 1;}else {break;}}} // map the hash to an array for sorting
for(var k=1;k < max_size;k++) {results[k] = [];var key=keys[k];var words=Object.keys(keys[k]);for(var _i49=0;_i49 < words.length;_i49++) {var word=words[_i49];if(key[word] >= min_count){results[k].push({'word':word,'count':key[word],'size':k});}}} //post-process + sort
...
module.exports = ngram;},{"../fns.js":20}],71:[function(require,module,exports){ //(Rule-based sentence boundary segmentation) - chop given text into its proper sentences.
...
var chunks_length=chunks.length;for(var _i50=0;_i50 < chunks_length;_i50++) {if(chunks[_i50]){ //trim whitespace
chunks[_i50] = chunks[_i50].replace(/^\s+|\s+$/g,''); //should this chunk be combined with the next one?
if(chunks[_i50 + 1] && chunks[_i50].match(abbrev_reg) || chunks[_i50].match(acronym_reg) || chunks[_i50].match(elipses_reg)){chunks[_i50 + 1] = ((chunks[_i50] || '') + ' ' + (chunks[_i50 + 1] || '')).replace(/ +/g,' ');}else if(chunks[_i50] && chunks[_i50].length > 0){ //this chunk is a proper sentence..
sentences.push(chunks[_i50]);chunks[_i50] = '';}}} //if we never got a sentence, return the given text
if(sentences.length === 0){return [text];}return sentences;};module.exports = sentence_parser;},{"../data/abbreviations":3}],72:[function(require,module,exports){'use strict';var sentence_parser=require('./sentence_parser.js');var Sentence=require('../sentence/sentence.js');var _ngram=require('./ngram.js');var fns=require('../fns.js'); //a text object is a series of sentences, along with the generic methods for transforming them
