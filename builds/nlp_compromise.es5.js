...
var suffix_rules=require('./suffix_rules');var fns=require('../../../fns.js');var predict=function predict(w){if(w.match(/will ha(ve|d) [a-z]{2}/)){return 'future_perfect';}if(w.match(/will [a-z]{2}/)){return 'future';}if(w.match(/had [a-z]{2}/)){return 'pluperfect';}if(w.match(/have [a-z]{2}/)){return 'perfect';}if(w.match(/..erer$/)){return 'actor';}var arr=Object.keys(suffix_rules);for(var _i50=0;_i50 < arr.length;_i50++) {if(fns.endsWith(w,arr[_i50])){return suffix_rules[arr[_i50]];}}return 'infinitive';};module.exports = predict;},{"../../../fns.js":20,"./suffix_rules":66}],66:[function(require,module,exports){'use strict'; //generated from test data
