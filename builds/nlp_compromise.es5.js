...
_createClass(Adverb,[{key:"to_adjective",value:function to_adjective(){return _to_adjective(this.normal);}}]);return Adverb;})(Term);module.exports = Adverb;},{"../term.js":62,"./to_adjective.js":36}],36:[function(require,module,exports){ //turns 'quickly' into 'quick'
...
return 'Female';}if(firstName.match(/[ou]$/)){ //if it ends in a 'oh or uh', male
return 'Male';}if(firstName.match(/(nn|ll|tt)/)){ //if it has double-consonants, female
...
if(words[words.length - 1]){this.lastName = words[words.length - 1];words = words.slice(0,words.length - 1);}this.middleName = words.join(' ');}},{key:"gender",value:function gender(){return guess_gender(this.normal,this.firstName);}}]);return Person;})(Noun);module.exports = Person; // let p = new Person('John Smith');
// console.log(p.gender());
},{"../../../data/firstnames":8,"../../../data/honourifics":9,"../noun.js":45,"./gender.js":48}],51:[function(require,module,exports){'use strict';var places=require('../../../data/places');var abbreviations=require('../../../data/abbreviations'); //add Country names
...
this.unit = w;if(units[w]){this.measurement = units[w].category;this.unit_name = units[w].name;}}}this.number = to_number(numbers);}}]);return Value;})(Noun);module.exports = Value;},{"../noun.js":45,"./numbers.js":57,"./to_number.js":58,"./units.js":59}],61:[function(require,module,exports){ //chop a string into pronounced syllables
...
str = str.replace(/[\u201C\u201D\u201E\u201F\u2033\u2036]+/g,'"');if(!str.match(/[a-z0-9]/i)){return '';}this.normal = str;return this.normal;}},{key:"americanize",value:function americanize(){return _americanize(this.normal);}},{key:"britishize",value:function britishize(){return _britishize(this.normal);}},{key:"syllables",value:function syllables(){return _syllables(this.normal);}}]);return Term;})();module.exports = Term;},{"./americanize":37,"./britishize":38,"./syllables":61}],63:[function(require,module,exports){ //turn a verb into its other grammatical forms.
