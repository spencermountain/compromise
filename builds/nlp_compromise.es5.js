...
var dates=['jan','feb','mar','apr','jun','jul','aug','sep','oct','nov','dec','sept','sep'];main = main.concat(dates);module.exports = {abbreviations:main,dates:dates,orgs:orgs,places:places};},{"./honourifics":8}],4:[function(require,module,exports){ //adjectives that either aren't covered by rules, or have superlative/comparative forms
...
var organisations=['google','microsoft','walmart','exxonmobil','glencore','samsung','chevron','at&t','verizon','costco','nestlé','7-eleven','adidas','nike','acer','mcdonalds','mcdonald\'s','comcast','compaq','craigslist','cisco','disney','coca cola','dupont','ebay','facebook','fedex','kmart','kodak','monsanto','myspace','netflix','sony','telus','twitter','usps','ubs','ups','walgreens','youtube','yahoo!','yamaha'];var suffixes=['center','centre','memorial','school','university','bank','college','house','foundation','department','institute','club','co','sons'];module.exports = {suffixes:suffixes,organisations:organisations};},{}],14:[function(require,module,exports){ //phrasal verbs are two words that really mean one verb.
...
},{}],18:[function(require,module,exports){ //most-frequent non-irregular verbs, to be conjugated for the lexicon
//this list is the seed, from which various forms are conjugated
...
var n=nlp.Text('Twenty-eight months have passed'); // since September 11th, 2001 - over two years without an attack on American soil');
console.log(n.terms());},{"./lexicon.js":21,"./term/adjective/adjective.js":30,"./term/adverb/adverb.js":36,"./term/noun/date/date.js":41,"./term/noun/noun.js":46,"./term/noun/organisation/organisation.js":48,"./term/noun/person/person.js":50,"./term/noun/place/place.js":52,"./term/noun/value/value.js":59,"./term/term.js":61,"./term/verb/verb.js":68,"./text/text.js":71}],21:[function(require,module,exports){ //the lexicon is a big hash of words to pos tags
//it's built by conjugating and inflecting a small seed of terms
'use strict';var fns=require('./fns.js');var verb_conjugate=require('./term/verb/conjugate/conjugate.js');var lexicon={};var addObj=function addObj(obj){var keys=Object.keys(obj);var l=keys.length;for(var _i7=0;_i7 < l;_i7++) {lexicon[keys[_i7]] = obj[keys[_i7]];}};var addArr=function addArr(arr,tag){var l=arr.length;for(var _i8=0;_i8 < l;_i8++) {lexicon[arr[_i8]] = tag;}}; //conjugate all verbs.
var verb_forms={infinitive:'VBP',past:'VBD',gerund:'VBG',present:'VBZ',actor:'NNA',participle:'VBN'};var verbs=require('./data/verbs.js');var _loop=function(_i9){var c=verb_conjugate(verbs[_i9]);Object.keys(c).forEach(function(k){if(k && verb_forms[k]){lexicon[c[k]] = verb_forms[k];}});};for(var _i9=0;_i9 < verbs.length;_i9++) {_loop(_i9);} //irregular verbs
require('./data/verb_irregulars.js').forEach(function(o){Object.keys(o).forEach(function(k){if(k && verb_forms[k]){lexicon[o[k]] = verb_forms[k];}});});var orgs=require('./data/organisations.js');addArr(orgs.organisations,'Noun');addArr(orgs.suffixes,'Noun');var places=require('./data/places.js');addArr(places.countries,'Noun');addArr(places.cities,'Noun');addArr(require('./data/abbreviations.js').abbreviations,'NNAB');addArr(require('./data/adjectives.js'),'Adjective');addArr(require('./data/demonyms.js'),'Adjective');addArr(require('./data/honourifics.js'),'NNAB');addArr(require('./data/uncountables.js'),'Noun');addArr(require('./data/dates.js'),'Value');addArr(require('./data/numbers.js'),'Value'); //a little fancy
addArr(Object.keys(require('./data/firstnames.js')),'Noun'); //add irregular nouns
var irregNouns=require('./data/irregular_nouns.js');addArr(fns.pluck(irregNouns,0),'Noun');addArr(fns.pluck(irregNouns,1),'NNS');addObj(require('./data/misc.js'));addObj(require('./data/multiples.js'));addObj(require('./data/phrasal_verbs.js')); //just in case
lexicon[false] = undefined;lexicon[true] = undefined;lexicon[undefined] = undefined;lexicon[null] = undefined;lexicon[''] = undefined; // console.log(Object.keys(lexicon).length)
// console.log(lexicon)
...
console.log(lexicon['canada'] === 'Noun'); // console.log(lexicon['the']);
module.exports = lexicon;},{"./data/abbreviations.js":3,"./data/adjectives.js":4,"./data/dates.js":5,"./data/demonyms.js":6,"./data/firstnames.js":7,"./data/honourifics.js":8,"./data/irregular_nouns.js":9,"./data/misc.js":10,"./data/multiples.js":11,"./data/numbers.js":12,"./data/organisations.js":13,"./data/phrasal_verbs.js":14,"./data/places.js":15,"./data/uncountables.js":16,"./data/verb_irregulars.js":17,"./data/verbs.js":18,"./fns.js":19,"./term/verb/conjugate/conjugate.js":62}],22:[function(require,module,exports){'use strict';var pos=require('./pos');var Noun=pos.Noun;var Verb=pos.Verb;var Adjective=pos.Adjective;var Adverb=pos.Adjective;var Term=pos.Term;var mapping={'NN':Noun,'NNA':Noun,'NNP':Noun,'NNO':Noun,'NNPA':Noun,'NNAB':Noun,'NNPS':Noun,'NNS':Noun,'NNG':Noun,'PP':Noun,'PRP':Noun,'CD':Noun,'NU':Noun,'DA':Noun,'VB':Verb,'VBD':Verb,'VBP':Verb,'VBG':Verb,'VBF':Verb,'VBN':Verb,'VBZ':Verb,'CP':Verb,'MD':Verb,'JJ':Adjective,'JJR':Adjective,'JJS':Adjective,'RB':Adverb,'RBR':Adverb,'RBS':Adverb,'Adjective':Adjective,'Verb':Verb,'Adverb':Adverb,'Noun':Noun,'Value':pos.Value,'Place':pos.Place,'Person':pos.Person,'Date':pos._Date}; //swap the Term object with a proper Pos class
var assign=function assign(t,tag,reason){var P=mapping[tag] || Term;t = new P(t.text,tag);t.reason = reason;return t;};module.exports = assign;},{"./pos":26}],23:[function(require,module,exports){ //add a 'quiet' token for contractions so we can represent their grammar
...
{'before':['Modal','Value'],'after':['Modal','Verb']},{'before':['Adverb','Value'],'after':['Adverb','Verb']}];},{}],25:[function(require,module,exports){'use strict';var assign=require('./assign');var lexicon=require('../../lexicon.js'); //consult lexicon for this known-word
...
s.terms = specific_pos(s.terms);return s.terms;};module.exports = tagger;},{"../../fns":19,"./assign":22,"./contractions":23,"./grammar_rules":24,"./lexicon_pass":25,"./pos":26,"./word_rules":28}],28:[function(require,module,exports){ //regex patterns and parts of speech],
...
module.exports = adj_to_adv;},{}],33:[function(require,module,exports){ //turn 'quick' into 'quickly'
...
module.exports = to_comparative;},{"./convertables":31}],34:[function(require,module,exports){ //convert cute to cuteness
...
module.exports = to_noun;},{}],35:[function(require,module,exports){ //turn 'quick' into 'quickest'
...
module.exports = to_adjective;},{}],38:[function(require,module,exports){ // convert british spellings into american ones
...
module.exports = americanize;},{}],39:[function(require,module,exports){ // convert american spellings into british ones
// built with patterns+exceptions from https://en.wikipedia.org/wiki/British_spelling
...
module.exports = britishize;},{}],40:[function(require,module,exports){'use strict'; //chooses an indefinite aricle 'a/an' for a word
...
module.exports = extractDates;},{"sugar-date":2}],44:[function(require,module,exports){'use strict';var irregulars=require('../../data/irregular_nouns'); //similar to plural/singularize rules, but not the same
...
module.exports = is_plural;},{"../../data/irregular_nouns":9}],45:[function(require,module,exports){ //uncountables are words that shouldn't ever inflect, for metaphysical reasons, like 'peace'
...
},{key:"is_person",value:function is_person(){return _is_person(this.normal);}},{key:"is_organisation",value:function is_organisation(){return _is_organisation(this.normal,this.text);}},{key:"is_date",value:function is_date(){return _is_date(this.normal);}},{key:"is_value",value:function is_value(){return _is_value(this.normal);}},{key:"is_place",value:function is_place(){return _is_place(this.normal);}}]);return Noun;})(Term);module.exports = Noun;},{"../term.js":61,"./article.js":40,"./date/is_date.js":42,"./is_plural.js":44,"./is_uncountable.js":45,"./organisation/is_organisation.js":47,"./person/is_person.js":49,"./place/is_place.js":51,"./pluralize.js":53,"./singularize.js":54,"./value/is_value.js":55}],47:[function(require,module,exports){'use strict';var firstnames=require('../../../data/firstnames');var abbreviations=require('../../../data/abbreviations');var org_data=require('../../../data/organisations'); //words like 'co' and ltd
...
}}]);return Person;})(Noun);module.exports = Person;},{"../../../data/firstnames":7,"../../../data/honourifics":8,"../noun.js":46}],51:[function(require,module,exports){'use strict';var places=require('../../../data/places');var abbreviations=require('../../../data/abbreviations'); //add Country names
...
this.unit = w;if(units[w]){this.measurement = units[w].category;this.unit_name = units[w].name;}}}this.number = to_number(numbers);}}]);return Value;})(Noun);module.exports = Value;},{"../noun.js":46,"./numbers.js":56,"./to_number.js":57,"./units.js":58}],60:[function(require,module,exports){ //chop a string into pronounced syllables
...
module.exports = syllables;},{}],61:[function(require,module,exports){'use strict';var _syllables=require('./syllables');var _americanize=require('./americanize');var _britishize=require('./britishize');var Term=(function(){function Term(str,tag){_classCallCheck(this,Term);this.changeTo(str);this.reason = '';var types={DT:'Determiner',CC:'Conjunction',IN:'Preposition'};this.pos = types[tag] || '?';} // let t = new Term("synthesise")
...
str = str.replace(/[\u201C\u201D\u201E\u201F\u2033\u2036]+/g,'"');if(!str.match(/[a-z0-9]/i)){return '';}this.normal = str;return this.normal;}},{key:"americanize",value:function americanize(){return _americanize(this.normal);}},{key:"britishize",value:function britishize(){return _britishize(this.normal);}},{key:"syllables",value:function syllables(){return _syllables(this.normal);}}]);return Term;})();module.exports = Term;},{"./americanize":38,"./britishize":39,"./syllables":60}],62:[function(require,module,exports){ //turn a verb into its other grammatical forms.
...
},{"../../../data/verb_irregulars":17,"./predict_form.js":63,"./to_actor":65,"./verb_rules":66}],63:[function(require,module,exports){'use strict'; //this method is used to predict which current conjugation a verb is
...
module.exports = actor;},{}],66:[function(require,module,exports){ // regex rules for each part of speech that convert it to all other parts of speech.
...
},{}],67:[function(require,module,exports){'use strict'; //recieves a verb object, and returns a negated string
...
},{key:"isNegative",value:function isNegative(){var str=this.normal;if(str.match(/(n't|\bnot\b)/)){return true;}return false;}},{key:"negate",value:function negate(){if(this.isNegative()){return this.text;}this.changeTo(_negate(this));return this.text;}}]);return Verb;})(Term);module.exports = Verb;},{"../term.js":61,"./conjugate/conjugate.js":62,"./conjugate/predict_form.js":63,"./negate.js":67}],69:[function(require,module,exports){'use strict'; //split a string into all possible parts
...
module.exports = ngram;},{"../fns.js":19}],70:[function(require,module,exports){ //(Rule-based sentence boundary segmentation) - chop given text into its proper sentences.
