...
},{key:"isNegative",value:function isNegative(){var str=this.normal;if(str.match(/(n't|\bnot\b)/)){return true;}return false;}},{key:"negate",value:function negate(form){if(this.isNegative()){return this.text;}this.changeTo(_negate(this,form));return this.text;}}]);return Verb;})(Term);module.exports = Verb;},{"../term.js":63,"./conjugate/conjugate.js":64,"./conjugate/predict_form.js":65,"./negate.js":69}],71:[function(require,module,exports){'use strict'; //split a string into all possible parts
