...
for(var _i22=0;_i22 < 2;_i22++) {s.terms = grammar_rules_pass(s);s.terms = chunk_neighbours(s.terms);s.terms = noun_fallback(s.terms);s.terms = specific_pos(s.terms);s.terms = contractions.hard_ones(s.terms);s.terms = fancy_lumping(s.terms);}return s.terms;};module.exports = tagger;},{"../../fns":20,"../../lexicon.js":22,"./contractions":23,"./fancy_lumping":24,"./grammar_rules":25,"./pos":26,"./word_rules":28}],28:[function(require,module,exports){var tag_mapping=require('./pos.js').tag_mapping; //regex patterns and parts of speech],
...
_createClass(Adverb,[{key:"to_adjective",value:function to_adjective(){return _to_adjective(this.normal);}}]);return Adverb;})(Term);module.exports = Adverb;},{"../term.js":63,"./to_adjective.js":36}],36:[function(require,module,exports){ //turns 'quickly' into 'quick'
...
for(var _i36=0;_i36 < irregulars.length;_i36++) {if(irregulars[_i36][1] === str){return true;}if(irregulars[_i36][0] === str){return false;}}for(var _i37=0;_i37 < plural_indicators.length;_i37++) {if(str.match(plural_indicators[_i37])){return true;}}for(var _i38=0;_i38 < singular_indicators.length;_i38++) {if(str.match(singular_indicators[_i38])){return false;}} // some 'looks pretty plural' rules
...
},{"../term.js":63,"./article.js":39,"./date/is_date.js":41,"./is_plural.js":43,"./is_uncountable.js":44,"./organisation/is_organisation.js":46,"./person/is_person.js":49,"./place/is_place.js":52,"./pluralize.js":54,"./pronoun.js":55,"./singularize.js":56,"./value/is_value.js":57}],46:[function(require,module,exports){'use strict';var firstnames=require('../../../data/firstnames');var abbreviations=require('../../../data/abbreviations');var org_data=require('../../../data/organisations'); //words like 'co' and ltd
...
},{"../../../data/firstnames":8,"../../../data/honourifics":9}],51:[function(require,module,exports){ // not all cultures use the firstname-lastname practice. this does make some assumptions.
...
},{"../../../data/honourifics":9,"../noun.js":45,"./gender.js":48,"./parse_name.js":50}],52:[function(require,module,exports){'use strict';var places=require('../../../data/places');var abbreviations=require('../../../data/abbreviations'); //add Country names
...
for(var _i40=0;_i40 < pluralize_rules.length;_i40++) {if(str.match(pluralize_rules[_i40].reg)){return str.replace(pluralize_rules[_i40].reg,pluralize_rules[_i40].repl);}}}; // console.log(pluralize('gas') === "gases")
...
for(var _i41=0;_i41 < singularize_rules.length;_i41++) {if(str.match(singularize_rules[_i41].reg)){return str.replace(singularize_rules[_i41].reg,singularize_rules[_i41].repl);}}return str;}; // console.log(singularize('gases') === "gas")
...
var mults=[{reg:/^(minus|negative)[\s\-]/i,mult:-1},{reg:/^(a\s)?half[\s\-](of\s)?/i,mult:0.5},{reg:/^(a\s)?quarter[\s\-]/i,mult:0.25}];for(var _i43=0;_i43 < mults.length;_i43++) {if(s.match(mults[_i43].reg)){global_multiplier = mults[_i43].mult;s = s.replace(mults[_i43].reg,'');break;}} //do each word in turn..
var words=s.toString().split(/[\s\-]+/);var w=undefined,x=undefined;var current_sum=0;var local_multiplier=1;var decimal_mode=false;for(var _i44=0;_i44 < words.length;_i44++) {w = words[_i44]; //skip 'and' eg. five hundred and twelve
...
str = str.replace(/[\u201C\u201D\u201E\u201F\u2033\u2036]+/g,'"');if(!str.match(/[a-z0-9]/i)){return '';}this.normal = str;return this.normal;}},{key:"americanize",value:function americanize(){return _americanize(this.normal);}},{key:"britishize",value:function britishize(){return _britishize(this.normal);}},{key:"syllables",value:function syllables(){return _syllables(this.normal);}}]);return Term;})();module.exports = Term;},{"./americanize":37,"./britishize":38,"./syllables":62}],64:[function(require,module,exports){ //turn a verb into its other grammatical forms.
...
var obj={};var l=verb_irregulars.length;for(var _i48=0;_i48 < l;_i48++) {var x=verb_irregulars[_i48];if(verb === x.present || verb === x.gerund || verb === x.past || verb === x.infinitive){obj = JSON.parse(JSON.stringify(verb_irregulars[_i48])); // object 'clone' hack, to avoid mem leak
...
l = verb_rules[predicted].length;for(var _i49=0;_i49 < l;_i49++) {var r=verb_rules[predicted][_i49];if(w.match(r.reg)){obj[predicted] = w;var keys=Object.keys(r.repl);for(var o=0;o < keys.length;o++) {if(keys[o] === predicted){obj[keys[o]] = w;}else {obj[keys[o]] = w.replace(r.reg,r.repl[keys[o]]);}}return fufill(obj);}} //produce a generic transformation
...
},{"../../../data/verb_irregulars":18,"./predict_form.js":65,"./to_actor":67,"./verb_rules":68}],65:[function(require,module,exports){'use strict'; //this method is used to predict which current conjugation a verb is
//this method is the slowest in the whole library, basically TODO:whaaa
var suffix_rules=require('./suffix_rules');var fns=require('../../../fns.js');var predict=function predict(w){if(w.match(/will ha(ve|d) [a-z]{2}/)){return 'future_perfect';}if(w.match(/will [a-z]{2}/)){return 'future';}if(w.match(/had [a-z]{2}/)){return 'pluperfect';}if(w.match(/have [a-z]{2}/)){return 'perfect';}var arr=Object.keys(suffix_rules);for(var _i50=0;_i50 < arr.length;_i50++) {if(fns.endsWith(w,arr[_i50])){return suffix_rules[arr[_i50]];}}return 'infinitive';};module.exports = predict;},{"../../../fns.js":20,"./suffix_rules":66}],66:[function(require,module,exports){'use strict'; //generated from test data
var compact={'gerund':['ing'],'infinitive':['ate','ize','tion','rify','ress','ify','age','nce','ect','ise','ine','ish','ace','ash','ure','tch','end','ack','and','ute','ade','ock','ite','ase','ose','use','ive','int','nge','lay','est','ain','ant','eed','er','le'],'past':['ed','lt','nt','pt','ew','ld'],'present':['rks','cks','nks','ngs','mps','tes','zes','ers','les','acks','ends','ands','ocks','lays','eads','lls','els','ils','ows','nds','ays','ams','ars','ops','ffs','als','urs','lds','ews','ips','es','ts','ns','s']};var suffix_rules={};var keys=Object.keys(compact);var l=keys.length;var l2=undefined;for(var _i51=0;_i51 < l;_i51++) {l2 = compact[keys[_i51]].length;for(var o=0;o < l2;o++) {suffix_rules[compact[keys[_i51]][o]] = keys[_i51];}}module.exports = suffix_rules;},{}],67:[function(require,module,exports){ //somone who does this present-tense verb
//turn 'walk' into 'walker'
'use strict';var actor=function actor(str){str = str || '';var irregulars={'tie':'tier','dream':'dreamer','sail':'sailer','run':'runner','rub':'rubber','begin':'beginner','win':'winner','claim':'claimant','deal':'dealer','spin':'spinner'};var dont={'aid':1,'fail':1,'appear':1,'happen':1,'seem':1,'try':1,'say':1,'marry':1,'be':1,'forbid':1,'understand':1,'bet':1};var transforms=[{'reg':/e$/i,'repl':'er'},{'reg':/([aeiou])([mlgp])$/i,'repl':'$1$2$2er'},{'reg':/([rlf])y$/i,'repl':'$1ier'},{'reg':/^(.?.[aeiou])t$/i,'repl':'$1tter'}];if(dont.hasOwnProperty(str)){return null;}if(irregulars.hasOwnProperty(str)){return irregulars[str];}for(var _i52=0;_i52 < transforms.length;_i52++) {if(str.match(transforms[_i52].reg)){return str.replace(transforms[_i52].reg,transforms[_i52].repl);}}return str + 'er';}; // console.log(verb_to_actor('set'))
// console.log(verb_to_actor('sweep'))
// console.log(verb_to_actor('watch'))
module.exports = actor;},{}],68:[function(require,module,exports){ // regex rules for each part of speech that convert it to all other parts of speech.
...
},{}],69:[function(require,module,exports){'use strict'; //recieves a verb object, and returns a negated string
//sort out don't/didn't/doesn't/won't
var negate=function negate(v){var exceptions={'is':'isn\'t','are':'aren\'t','was':'wasn\'t','will':'won\'t','had':'hadn\'t', //modals
...
var words=v.normal.split(' ');if(words.length > 1 && exceptions[words[0]]){return exceptions[words[0]] + ' ' + words.slice(1,words.length).join(' ');}var form=v.conjugation(); //walked -> didn't walk
...
this.conjugations = this.conjugate();var keys=Object.keys(this.conjugations);for(var _i53=0;_i53 < keys.length;_i53++) {if(this.conjugations[keys[_i53]] === this.normal){return verbTags[keys[_i53]];}}return verbTags[predict(this.normal)];}},{key:"conjugate",value:function conjugate(){this.conjugations = _conjugate(this.normal);return this.conjugations;}},{key:"to_past",value:function to_past(){var tense='past';if(!this.conjugations[tense]){this.conjugate(this.normal);}this.tag = verbTags[tense];this.changeTo(this.conjugations[tense]);return this.conjugations[tense];}},{key:"to_present",value:function to_present(){var tense='present';if(!this.conjugations[tense]){this.conjugate(this.normal);}this.tag = verbTags[tense];this.changeTo(this.conjugations[tense]);return this.conjugations[tense];}},{key:"to_future",value:function to_future(){var tense='future';if(!this.conjugations[tense]){this.conjugate(this.normal);}this.tag = verbTags[tense];this.changeTo(this.conjugations[tense]);return this.conjugations[tense];} //is this verb negative already?
},{key:"isNegative",value:function isNegative(){var str=this.normal;if(str.match(/(n't|\bnot\b)/)){return true;}return false;}},{key:"negate",value:function negate(){if(this.isNegative()){return this.text;}this.changeTo(_negate(this));return this.text;}}]);return Verb;})(Term);module.exports = Verb;},{"../term.js":63,"./conjugate/conjugate.js":64,"./conjugate/predict_form.js":65,"./negate.js":69}],71:[function(require,module,exports){'use strict'; //split a string into all possible parts
...
for(var _i54=1;_i54 <= max_size;_i54++) {keys.push({});} // Create a hash for counting..
var textlen=terms.length;for(var _i55=0;_i55 < textlen;_i55++) {var s=terms[_i55];keys[1][s] = (keys[1][s] || 0) + 1;for(var j=2;j <= max_size;j++) {if(_i55 + j <= textlen){s += ' ' + terms[_i55 + j - 1];keys[j][s] = (keys[j][s] || 0) + 1;}else {break;}}} // map the hash to an array for sorting
for(var k=1;k < max_size;k++) {results[k] = [];var key=keys[k];var words=Object.keys(keys[k]);for(var _i56=0;_i56 < words.length;_i56++) {var word=words[_i56];if(key[word] >= min_count){results[k].push({'word':word,'count':key[word],'size':k});}}} //post-process + sort
...
module.exports = ngram;},{"../fns.js":20}],72:[function(require,module,exports){ //(Rule-based sentence boundary segmentation) - chop given text into its proper sentences.
...
var chunks_length=chunks.length;for(var _i57=0;_i57 < chunks_length;_i57++) {if(chunks[_i57]){ //trim whitespace
chunks[_i57] = chunks[_i57].replace(/^\s+|\s+$/g,''); //should this chunk be combined with the next one?
if(chunks[_i57 + 1] && chunks[_i57].match(abbrev_reg) || chunks[_i57].match(acronym_reg) || chunks[_i57].match(elipses_reg)){chunks[_i57 + 1] = ((chunks[_i57] || '') + ' ' + (chunks[_i57 + 1] || '')).replace(/ +/g,' ');}else if(chunks[_i57] && chunks[_i57].length > 0){ //this chunk is a proper sentence..
sentences.push(chunks[_i57]);chunks[_i57] = '';}}} //if we never got a sentence, return the given text
if(sentences.length === 0){return [text];}return sentences;};module.exports = sentence_parser;},{"../data/abbreviations":3}],73:[function(require,module,exports){'use strict';var sentence_parser=require('./sentence_parser.js');var Sentence=require('../sentence/sentence.js');var _ngram=require('./ngram.js');var fns=require('../fns.js'); //a text object is a series of sentences, along with the generic methods for transforming them
...
},{key:"people",value:function people(){var arr=[];for(var _i58=0;_i58 < this.sentences.length;_i58++) {arr = arr.concat(this.sentences[_i58].people());}return arr;}},{key:"places",value:function places(){var arr=[];for(var _i59=0;_i59 < this.sentences.length;_i59++) {arr = arr.concat(this.sentences[_i59].places());}return arr;}},{key:"organisations",value:function organisations(){var arr=[];for(var _i60=0;_i60 < this.sentences.length;_i60++) {arr = arr.concat(this.sentences[_i60].organisations());}return arr;}},{key:"dates",value:function dates(){var arr=[];for(var _i61=0;_i61 < this.sentences.length;_i61++) {arr = arr.concat(this.sentences[_i61].dates());}return arr;}},{key:"values",value:function values(){var arr=[];for(var _i62=0;_i62 < this.sentences.length;_i62++) {arr = arr.concat(this.sentences[_i62].values());}return arr;}}]);return Text;})();module.exports = Text;},{"../fns.js":20,"../sentence/sentence.js":29,"./ngram.js":71,"./sentence_parser.js":72}]},{},[21]);
