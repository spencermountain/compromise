...
module.exports = misc;},{}],11:[function(require,module,exports){ //common terms that are multi-word, but one part-of-speech
...
var n=nlp.Text('terrorist leaders who');console.log(n.terms());},{"./lexicon.js":21,"./term/adjective/adjective.js":28,"./term/adverb/adverb.js":34,"./term/noun/date/date.js":39,"./term/noun/noun.js":44,"./term/noun/organisation/organisation.js":46,"./term/noun/person/person.js":48,"./term/noun/place/place.js":50,"./term/noun/value/value.js":57,"./term/term.js":59,"./term/verb/verb.js":66,"./text/text.js":69}],21:[function(require,module,exports){ //the lexicon is a big hash of words to pos tags
...
'VB':'Verb','VBD':'PastTense','VBF':'FutureTense','VBP':'Infinitive','VBG':'Gerund','VBN':'Verb','VBZ':'PresentTense','CP':'Copula','MD':'Modal','JJ':'Adjective','JJR':'Comparative','JJS':'Superlative','RB':'Adverb'};var classMapping={'Noun':Noun,'Honourific':Noun,'Acronym':Noun,'Plural':Noun,'Pronoun':Noun,'Name':Noun,'Verb':Verb,'PresentTense':Verb,'PastTense':Verb,'Infinitive':Verb,'Gerund':Verb,'Abbreviation':Verb,'Copula':Verb,'Modal':Verb,'Comparative':Adjective,'Superlative':Adjective,'Adjective':Adjective,'Determiner':Term,'Preposition':Term,'Expression':Term,'Conjunction':Term,'Posessive':Term,'Adverb':Adverb,'Value':Value,'Place':Place,'Person':Person,'Date':_Date};module.exports = {tag_mapping:tag_mapping,classMapping:classMapping,Term:Term,'Date':_Date,Value:Value,Verb:Verb,Person:Person,Place:Place,Organisation:Organisation,Adjective:Adjective,Adverb:Adverb,Noun:Noun};},{"../../term/adjective/adjective.js":28,"../../term/adverb/adverb.js":34,"../../term/noun/date/date.js":39,"../../term/noun/noun.js":44,"../../term/noun/organisation/organisation.js":46,"../../term/noun/person/person.js":48,"../../term/noun/place/place.js":50,"../../term/noun/value/value.js":57,"../../term/term.js":59,"../../term/verb/verb.js":66}],25:[function(require,module,exports){ //part-of-speech tagging
'use strict';var contractions=require('./contractions');var lexicon=require('../../lexicon.js');var word_rules=require('./word_rules');var grammar_rules=require('./grammar_rules');var fns=require('../../fns');var pos=require('./pos'); //swap the Term object with a proper Pos class
...
var chunk_neighbours=function chunk_neighbours(terms){var new_terms=[];var last=null;for(var _i13=0;_i13 < terms.length;_i13++) {var t=terms[_i13];if(last !== null && t.tag === last){new_terms[new_terms.length - 1].text += ' ' + t.text;new_terms[new_terms.length - 1].normalize();}else {new_terms.push(t);}last = t.tag;}return new_terms;}; //hints from the sentence grammar
...
s.terms = specific_pos(s.terms);return s.terms;};module.exports = tagger;},{"../../fns":19,"../../lexicon.js":21,"./contractions":22,"./grammar_rules":23,"./pos":24,"./word_rules":26}],26:[function(require,module,exports){var tag_mapping=require('./pos.js').tag_mapping; //regex patterns and parts of speech],
...
module.exports = adj_to_adv;},{}],31:[function(require,module,exports){ //turn 'quick' into 'quickly'
...
module.exports = to_comparative;},{"./convertables":29}],32:[function(require,module,exports){ //convert cute to cuteness
...
module.exports = to_noun;},{}],33:[function(require,module,exports){ //turn 'quick' into 'quickest'
...
module.exports = to_adjective;},{}],36:[function(require,module,exports){ // convert british spellings into american ones
...
module.exports = americanize;},{}],37:[function(require,module,exports){ // convert american spellings into british ones
// built with patterns+exceptions from https://en.wikipedia.org/wiki/British_spelling
...
module.exports = britishize;},{}],38:[function(require,module,exports){'use strict'; //chooses an indefinite aricle 'a/an' for a word
...
module.exports = extractDates;},{"sugar-date":2}],42:[function(require,module,exports){'use strict';var irregulars=require('../../data/irregular_nouns'); //similar to plural/singularize rules, but not the same
...
module.exports = is_plural;},{"../../data/irregular_nouns":9}],43:[function(require,module,exports){ //uncountables are words that shouldn't ever inflect, for metaphysical reasons, like 'peace'
...
},{key:"is_person",value:function is_person(){return _is_person(this.normal);}},{key:"is_organisation",value:function is_organisation(){return _is_organisation(this.normal,this.text);}},{key:"is_date",value:function is_date(){return _is_date(this.normal);}},{key:"is_value",value:function is_value(){return _is_value(this.normal);}},{key:"is_place",value:function is_place(){return _is_place(this.normal);}}]);return Noun;})(Term);module.exports = Noun;},{"../term.js":59,"./article.js":38,"./date/is_date.js":40,"./is_plural.js":42,"./is_uncountable.js":43,"./organisation/is_organisation.js":45,"./person/is_person.js":47,"./place/is_place.js":49,"./pluralize.js":51,"./singularize.js":52,"./value/is_value.js":53}],45:[function(require,module,exports){'use strict';var firstnames=require('../../../data/firstnames');var abbreviations=require('../../../data/abbreviations');var org_data=require('../../../data/organisations'); //words like 'co' and ltd
...
}}]);return Person;})(Noun);module.exports = Person;},{"../../../data/firstnames":7,"../../../data/honourifics":8,"../noun.js":44}],49:[function(require,module,exports){'use strict';var places=require('../../../data/places');var abbreviations=require('../../../data/abbreviations'); //add Country names
...
this.unit = w;if(units[w]){this.measurement = units[w].category;this.unit_name = units[w].name;}}}this.number = to_number(numbers);}}]);return Value;})(Noun);module.exports = Value;},{"../noun.js":44,"./numbers.js":54,"./to_number.js":55,"./units.js":56}],58:[function(require,module,exports){ //chop a string into pronounced syllables
...
module.exports = syllables;},{}],59:[function(require,module,exports){'use strict';var _syllables=require('./syllables');var _americanize=require('./americanize');var _britishize=require('./britishize');var Term=(function(){function Term(str,tag){_classCallCheck(this,Term);this.changeTo(str);this.reason = '';var types={Determiner:'Determiner',Conjunction:'Conjunction',Preposition:'Preposition',Posessive:'Posessive'};this.pos = 'Term';this.tag = types[tag] || '?';} // let t = new Term("synthesise")
...
str = str.replace(/[\u201C\u201D\u201E\u201F\u2033\u2036]+/g,'"');if(!str.match(/[a-z0-9]/i)){return '';}this.normal = str;return this.normal;}},{key:"americanize",value:function americanize(){return _americanize(this.normal);}},{key:"britishize",value:function britishize(){return _britishize(this.normal);}},{key:"syllables",value:function syllables(){return _syllables(this.normal);}}]);return Term;})();module.exports = Term;},{"./americanize":36,"./britishize":37,"./syllables":58}],60:[function(require,module,exports){ //turn a verb into its other grammatical forms.
...
},{"../../../data/verb_irregulars":17,"./predict_form.js":61,"./to_actor":63,"./verb_rules":64}],61:[function(require,module,exports){'use strict'; //this method is used to predict which current conjugation a verb is
...
module.exports = actor;},{}],64:[function(require,module,exports){ // regex rules for each part of speech that convert it to all other parts of speech.
...
},{}],65:[function(require,module,exports){'use strict'; //recieves a verb object, and returns a negated string
...
},{key:"isNegative",value:function isNegative(){var str=this.normal;if(str.match(/(n't|\bnot\b)/)){return true;}return false;}},{key:"negate",value:function negate(){if(this.isNegative()){return this.text;}this.changeTo(_negate(this));return this.text;}}]);return Verb;})(Term);module.exports = Verb;},{"../term.js":59,"./conjugate/conjugate.js":60,"./conjugate/predict_form.js":61,"./negate.js":65}],67:[function(require,module,exports){'use strict'; //split a string into all possible parts
...
module.exports = ngram;},{"../fns.js":19}],68:[function(require,module,exports){ //(Rule-based sentence boundary segmentation) - chop given text into its proper sentences.
