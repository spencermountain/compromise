export default [
  ...
  ['searching', 'search'],
  ['retaining', 'retain'],
  ['fulfilling', 'fulfill'], // Prefer the existing American spelling when recovering the root.
  ...
  ['weaving', 'weave'],
  ['milling', 'mill'],
  ['enrolling', 'enroll'], // Prefer enroll over enrol; a surface form has one canonical root.
  ['filming', 'film'],
  ['machining', 'machine'],
  ['healing', 'heal'],
  ...
  ['silencing', 'silence'],
  ['patching', 'patch'],
  ['instilling', 'instill'], // Prefer instill over instil, preserving the existing model.
  ['offloading', 'offload'],
  ['zoning', 'zone'],
  ['bolting', 'bolt'],
  ['meshing', 'mesh'],
