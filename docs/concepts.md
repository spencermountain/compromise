...
- [tag-definitions.md](tag-definitions.md) — the tag hierarchy, definitions, and spec examples
- [tagging-differences.md](tagging-differences.md) — conventions that differ from other taggers
