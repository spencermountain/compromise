...
;(function (global, factory) {
  ...
  var dateTagger = function dateTagger(doc) {
    doc
      .match('(spring|summer|winter|fall|autumn|springtime|wintertime|summertime)')
      .match('#Noun')
      .tag('Season', here$1)
  ...
  var fixUp = function fixUp(doc) {
    ...
    if (doc.has('#Date')) {
      ...
      if (d.has(knownDate)) {
        ...
        d.match('(this|last|next) #Date '.concat(knownDate, '$'))
          .unTag('Date')
          .lastTerm()
  ...
  var _build = {
    ...
    '8|n':
      '2/brunei,2/choibalsan,2/chongqing,2/chungking,2/harbin,2/hong_kong,2/irkutsk,2/kuching,2/macao,2/macau,2/manila,2/shanghai,2/taipei,2/ujung_pandang,2/ulaanbaatar',
    '8.75|s': '4/eucla',
    '7|s': '12/davis,2/jakarta,9/christmas',
    '7|n':
      '2/bangkok,2/barnaul,2/ho_chi_minh,2/hovd,2/krasnoyarsk,2/novokuznetsk,2/novosibirsk,2/phnom_penh,2/pontianak,2/saigon,2/tomsk,2/vientiane',
    '6|s': '12/vostok',
    ...
    '5|n':
      '2/aqtau,2/aqtobe,2/ashgabat,2/ashkhabad,2/atyrau,2/baku,2/dushanbe,2/karachi,2/oral,2/samarkand,2/tashkent,2/yekaterinburg,9/maldives',
    ...
    '3|n|03/29:03->10/25:04':
      '2/famagusta,2/nicosia,8/athens,8/bucharest,8/helsinki,8/kiev,8/mariehamn,8/nicosia,8/riga,8/sofia,8/tallinn,8/uzhgorod,8/vilnius,8/zaporozhye',
    ...
    '3|n':
      '0/addis_ababa,0/asmara,0/asmera,0/dar_es_salaam,0/djibouti,0/juba,0/kampala,0/mogadishu,0/nairobi,2/aden,2/baghdad,2/bahrain,2/istanbul,2/kuwait,2/qatar,2/riyadh,8/istanbul,8/kirov,8/minsk,8/moscow,8/simferopol,9/comoro,9/mayotte',
    '2|s|03/29:02->10/25:02': '12/troll',
    '2|s': '0/gaborone,0/harare,0/johannesburg,0/lubumbashi,0/lusaka,0/maputo,0/maseru,0/mbabane',
    '2|n|03/29:02->10/25:03':
      '0/ceuta,arctic/longyearbyen,3/jan_mayen,8/amsterdam,8/andorra,8/belgrade,8/berlin,8/bratislava,8/brussels,8/budapest,8/busingen,8/copenhagen,8/gibraltar,8/ljubljana,8/luxembourg,8/madrid,8/malta,8/monaco,8/oslo,8/paris,8/podgorica,8/prague,8/rome,8/san_marino,8/sarajevo,8/skopje,8/stockholm,8/tirane,8/vaduz,8/vatican,8/vienna,8/warsaw,8/zagreb,8/zurich',
    '2|n': '0/blantyre,0/bujumbura,0/cairo,0/khartoum,0/kigali,0/tripoli,8/kaliningrad',
    '1|s|04/02:01->09/03:03': '0/windhoek',
    '1|s': '0/kinshasa,0/luanda',
    '1|n|04/19:03->05/31:02': '0/casablanca,0/el_aaiun',
    '1|n|03/29:01->10/25:02':
      '3/canary,3/faeroe,3/faroe,3/madeira,8/belfast,8/dublin,8/guernsey,8/isle_of_man,8/jersey,8/lisbon,8/london',
    '1|n':
      '0/algiers,0/bangui,0/brazzaville,0/douala,0/lagos,0/libreville,0/malabo,0/ndjamena,0/niamey,0/porto-novo,0/tunis',
    '14|n': '11/kiritimati',
    ...
    '0|n':
      '0/abidjan,0/accra,0/bamako,0/banjul,0/bissau,0/conakry,0/dakar,0/freetown,0/lome,0/monrovia,0/nouakchott,0/ouagadougou,0/sao_tome,0/timbuktu,1/danmarkshavn,3/reykjavik,3/st_helena,13/gmt,13/gmt+0,13/gmt-0,13/gmt0,13/greenwich,13/utc,13/universal,13/zulu',
    '-9|n|03/08:02->11/01:02': '1/adak,1/atka',
    '-9|n': '11/gambier',
    '-9.5|n': '11/marquesas',
    '-8|n|03/08:02->11/01:02': '1/anchorage,1/juneau,1/metlakatla,1/nome,1/sitka,1/yakutat',
    '-8|n': '11/pitcairn',
    '-7|n|03/08:02->11/01:02':
      '1/dawson,1/ensenada,1/los_angeles,1/santa_isabel,1/tijuana,1/vancouver,1/whitehorse,6/pacific,6/yukon,10/bajanorte',
    ...
    '-6|n|03/08:02->11/01:02':
      '1/boise,1/cambridge_bay,1/denver,1/edmonton,1/inuvik,1/ojinaga,1/shiprock,1/yellowknife,6/mountain',
    '-6|n':
      '1/belize,1/costa_rica,1/el_salvador,1/guatemala,1/managua,1/regina,1/swift_current,1/tegucigalpa,6/east-saskatchewan,6/saskatchewan,11/galapagos',
    '-5|s': '1/lima,1/rio_branco,5/acre',
    '-5|n|04/05:02->10/25:02': '1/bahia_banderas,1/merida,1/mexico_city,1/monterrey,10/general',
    '-5|n|03/12:03->11/05:01': '1/north_dakota',
    '-5|n|03/08:02->11/01:02':
      '1/chicago,1/knox_in,1/matamoros,1/menominee,1/rainy_river,1/rankin_inlet,1/resolute,1/winnipeg,6/central',
    '-5|n':
      '1/atikokan,1/bogota,1/cancun,1/cayman,1/coral_harbour,1/eirunepe,1/guayaquil,1/jamaica,1/panama,1/porto_acre',
    ...
    '-4|n|03/08:02->11/01:02':
      '1/detroit,1/fort_wayne,1/grand_turk,1/indianapolis,1/iqaluit,1/louisville,1/montreal,1/nassau,1/new_york,1/nipigon,1/pangnirtung,1/port-au-prince,1/thunder_bay,1/toronto,6/eastern',
    ...
    '-3|s':
      '1/argentina,1/buenos_aires,1/cordoba,1/fortaleza,1/montevideo,1/punta_arenas,1/sao_paulo,12/rothera,3/stanley,5/east',
    '-3|n|03/08:02->11/01:02': '1/glace_bay,1/goose_bay,1/halifax,1/moncton,1/thule,3/bermuda,6/atlantic',
    '-3|n':
      '1/araguaina,1/bahia,1/belem,1/catamarca,1/cayenne,1/jujuy,1/maceio,1/mendoza,1/paramaribo,1/recife,1/rosario,1/santarem',
    '-2|s': '5/denoronha',
  ...
  var format = {
    ...
    numeric: function numeric(s) {
      return ''
        .concat(s.year(), '/')
        .concat(fns.zeroPad(s.month() + 1), '/')
        .concat(fns.zeroPad(s.date()))
    },
    // yyyy/mm/dd
    ...
    iso: function iso(s) {
      ...
      return ''
        ...
        .concat(second, '.')
        .concat(ms)
        .concat(offset) //2018-03-09T08:50:00.000-05:00
    },
    ...
    'nice-day': function niceDay(s) {
      return ''
        .concat(days['short']()[s.day()], ' ')
        .concat(fns.titleCase(months['short']()[s.month()]), ' ')
        .concat(fns.ordinal(s.date()))
    },
    'nice-full': function niceFull(s) {
      return ''
        .concat(s.dayName(), ' ')
        .concat(fns.titleCase(s.monthName()), ' ')
        .concat(fns.ordinal(s.date()), ', ')
        .concat(s.time())
    },
  } //aliases
  ...
  var holidays = [
    ...
    'victoria day',
    'womens equality day',
    'xmas', // Fixed religious and cultural holidays
    // Catholic + Christian
    'epiphany',
    ...
    'feast of our lady of guadalupe', // Kwanzaa
    'kwanzaa', // Pagan / metal 🤘
    'imbolc',
    'beltaine',
    'lughnassadh',
    ...
    'turkey day',
    'black friday',
    'cyber monday', // Astronomical religious and cultural holidays
    'ash wednesday',
    'palm sunday',
    'maundy thursday',
    'good friday',
    ...
    'yule',
    'december solstice',
    'winter solstice', // Additional important holidays
    'chinese new year',
    'diwali',
  ]
  ...
  var data$1 = [
    ...
    [holidays, '#Holiday'],
    [times, '#Time'],
    [Object.keys(_timezones), '#Timezone'],
  ]
