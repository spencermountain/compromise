...
test('chronic-tests-one', (t) => {
  ...
  t.equal(nlpDate('aug. 3'), mk(2007, 8, 3, 12))
  // t.equal(nlpDate('aug-20'), mk(2006, 8, 20, 12))
  ...
  // t.equal(nlpDate('may 27th 5:00 pm'), mk(2006, 5, 27, 17))
  // t.equal(nlpDate('may 27th at 5pm'), mk(2006, 5, 27, 17))
  ...
  // t.equal(nlpDate('5:00 pm may 27th'), mk(2006, 5, 27, 17))
  // t.equal(nlpDate('05:00 pm may 27th'), mk(2006, 5, 27, 17))
  // t.equal(nlpDate('5pm on may 27th'), mk(2006, 5, 27, 17))
  ...
  // t.equal(nlpDate('jan 3 2010 midnight'), mk(2010, 1, 4, 0))
  // t.equal(nlpDate('jan 3 2010 at midnight'), mk(2010, 1, 4, 0))
  ...
  t.equal(nlpDate('November 18th, 2010'), mk(2010, 11, 18, 12))
  // t.equal(nlpDate('November 18th 2010 midnight'), mk(2010, 11, 19, 0))
  ...
  // t.equal(nlpDate('1/1'), mk(2006, 1, 1, 12),'dd/mm')
  // t.equal(nlpDate('2012-06'), mk(2012, 06, 16))
  // t.equal(nlpDate('2013/12'), mk(2013, 12, 16, 12, 0))
  t.end()
})
...
test('chronic-tests-two', (t) => {
  ...
  // t.equal(nlpDate('13:00'), mk(2006, 8, 17, 13), 'times')
  // t.equal(nlpDate('13:45'), mk(2006, 8, 17, 13, 45), 'times')
  ...
  // t.equal(nlpDate('this day'), mk(2006, 8, 16, 7))
  ...
  // t.equal(nlpDate('next monday at 12:01 am'), mk(2006, 8, 21, 00, 1))
