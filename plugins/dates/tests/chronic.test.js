...
test('chronic-tests-two', (t) => {
  ...
  // //future
  t.equal(nlpDate('3 years from now'), mk(2009, 8, 16, 14, 0, 0), 'from now')
  // t.equal(nlpDate('6 months hence'), mk(2007, 2, 16, 14))
  // t.equal(nlpDate('3 fortnights hence'), mk(2006, 9, 27, 14))
  t.equal(nlpDate('1 week from now'), mk(2006, 8, 23, 14, 0, 0), 'from now')
  ...
  t.equal(nlpDate('1 hour from now'), mk(2006, 8, 16, 15), 'from now')
  // t.equal(nlpDate('20 minutes hence'), mk(2006, 8, 16, 14, 20))
  t.equal(nlpDate('20 seconds from now'), mk(2006, 8, 16, 14, 0, 20), 'from now')
  // t.equal(nlpDate('2 months ago'), mk(2007, 1, 7, 23, 30))
  // //Two repeaters
  t.equal(nlpDate('25 minutes and 20 seconds from now'), mk(2006, 8, 16, 14, 25, 20), 'from now')
  // t.equal(nlpDate('24 hours and 20 minutes from now'), mk(2006, 8, 17, 14, 20, 0), 'from now')
  t.equal(nlpDate('24 hours 20 minutes from now'), mk(2006, 8, 17, 14, 20, 0), 'from now')
  t.equal(nlpDate('in 3 hours'), mk(2006, 8, 16, 17), 'from now')
  // //past
