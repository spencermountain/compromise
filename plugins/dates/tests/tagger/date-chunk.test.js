...
test('date-chunk :', function(t) {
  let arr = [
    ...
    ['hey @begin, i gotta get my homework finished tonight', 'tonight'],
    ...
    ['@begin tell me to buy cheeseburgers tuesday night for everybody', 'tuesday night'],
    ["@begin i'd like to watch the space shuttle launch tonight", 'tonight'],
    ...
    ['@begin check my stocks in the morning', 'in the morning'],
