...
(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.compromiseStrictMatch = factory());
  ...
  var NLPMatchParser = /*#__PURE__*/function (_EmbeddedActionsParse) {
    _inherits(NLPMatchParser, _EmbeddedActionsParse);

    var _super = _createSuper(NLPMatchParser);

    function NLPMatchParser() {
      var _this;

      _classCallCheck(this, NLPMatchParser);
        ...
        $.OPTION(function () {
          ...
          switch (type) {
            ...
            case "RANGE":
              ...
              if (!greedy) {
                var _maxInst, _maxInst$locs;

                (_maxInst = maxInst) === null || _maxInst === void 0 ? void 0 : (_maxInst$locs = _maxInst.locs) === null || _maxInst$locs === void 0 ? void 0 : _maxInst$locs.reverse(); // reverse thread priority for greedy / non-greedy
              } //{ code: SPLIT, locs: [ ] }
          ...
          if (!greedy) {
            ...
            split === null || split === void 0 ? void 0 : (_split$locs = split.locs) === null || _split$locs === void 0 ? void 0 : _split$locs.reverse();
          }
        });
      });
  ...
  var thread = function thread(pc) {
    ...
    var ngroups = Object.values(groups).reduce(function (ng, g) {
      ng[g.id] = _objectSpread2(_objectSpread2({}, g), {}, {
        saved: _toConsumableArray(g.saved)
      });
      return ng;
    }, {});
    return {
  ...
  var saveMatch = function saveMatch(th, sp) {
    ...
    var buckets = [th.saved].concat(_toConsumableArray(Object.values(th.groups).filter(function (g) {
      return g.open;
    }).map(function (g) {
      return g.saved;
    })));
  ...
  var pikevm = function pikevm(prog, input) {
    ...
    var END = Symbol("END");
    input = [].concat(_toConsumableArray(input), [END]);
  ...
  var NLPRegexP = /*#__PURE__*/function () {
    ...
    _createClass(NLPRegexP, [{
      ...
      value: function exec(docOrPhrase) {
        var _docOrPhrase$isA;

        switch (docOrPhrase === null || docOrPhrase === void 0 ? void 0 : (_docOrPhrase$isA = docOrPhrase.isA) === null || _docOrPhrase$isA === void 0 ? void 0 : _docOrPhrase$isA.toLowerCase()) {
          case "doc":
