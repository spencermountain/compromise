...
let arr = [
  ...
  ` working together to master the dance routine`,
  `Please lower the volume`,
  `She couldn't help but giggle`,
  `The boat floats on the water.`,
  `They will fast before`,
  `The school exempts students`,
  `They dream of owning their own business.`,
  `They are working hard to attain financial stability.`,
  `They forgot to bill me`,
  `The news is broadcast at 6 p.m.`,
  `Don't let fear constrain you`,
  ...
  `The criminal used a van to abduct the child.`,
  `Her hair started to gray as she aged.`,
  `The magician made a rabbit appear from his hat.`,
  `He is learning to articulate his thoughts.`,
  `She struggled to articulate her emotions in words.`,
  `The professor teaches students how to articulate their arguments.`,
  `She used her hands to articulate her ideas.`,
  `She is determined to attain her fitness goals.`,
  `They are working hard to attain financial stability.`,
  `On average, it takes two hours to complete the test.`,
  `The seal barks to communicate with others.`,
  `She bests her own record in every race.`,
  ...
  `The news is broadcast at 6 p.m.`,
  `Please caution me if I make a mistake.`,
  `The teacher cautions the students to be careful.`,
  `The rules constrain us to follow certain procedures.`,
  `Don't let fear constrain you from pursuing your dreams.`,
  `How much does this shirt cost?`,
  `The doctor advised him to try cough syrup.`,
  ...
  `They dream of owning their own business.`,
  `The school exempts students from taking certain exams.`,
  `They will fast before the medical procedure.`,
  `The boat floats on the water.`,
  `She watched the cloud float away.`,
  `He filled the pool and watched the plastic duck float.`,
  `She couldn't help but giggle at the funny video.`,
  ...
  `They are working together to master the dance routine.`,
  `He is trying to perfect his piano skills.`,
  `She practices every day to perfect her dance moves.`,
  `They are working hard to perfect their English pronunciation.`,
  `I need to practice more to perfect my cooking skills.`,
  `The hammer pounds the nail into the wood.`,
  `I pound the dough to make bread.`,
  `He pounds his fist on the table in frustration.`,
  `The rain pounds against the window pane.`,
  `She was a victim of a brutal rape.`,
  `They round out their meal with dessert.`,
  `Don't let one mistake ruin your day.`,
  `The bakery smells like freshly baked bread.`,
  `I couldn't help but sob when I heard the sad news.`,
  `The car is speeding down the highway.`,
  `The NGO sponsors educational programs for underprivileged children.`,
  `The old man stoops to pet the cat.`,
  `Fish surface to breathe in oxygen.`,
  `The crowd sways to the music at the concert.`,
  `The dictator used torture to silence dissent.`,
  `He is always in trouble with his boss.`,
  `The couple wed in a traditional church wedding.`,
