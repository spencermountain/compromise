export default [
  ...
  { match: '#Gerund [#Gerund] #Plural', hook: '#Gerund', group: 0, tag: 'Adjective', notIf: '(impersonating|practicing|considering|assuming|enjoying|avoiding|stopping|starting|finishing)', reason: 'hard-working-fam' },
]
