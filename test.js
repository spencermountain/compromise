...
s = nlp.singularize("farmhouses")
s = nlp.singularize("earthquakes")
// console.log(s)

s = nlp.adj_to_noun("sterling")
s = nlp.adj_to_noun("fancy")
// console.log(s)


arr = nlp.tag("Tony Hawk walked quickly to the store.")
// console.log(arr)

nouns = nlp.spot("Tony Hawk walked quickly to the store.")
// console.log(nouns)
...
function test_spot() {
    ...
    assert_spot("tom cruise and nancy kerrigan", {
        stick_prepositions: true
    }, ["tom cruise", "nancy kerrigan", "tom cruise and nancy kerrigan"])
    assert_spot("tom cruise and nancy kerrigan", {
        subnouns: true,
        stick_prepositions: true
    }, ["tom cruise", "nancy kerrigan", "cruise", "nancy", "kerrigan", "tom cruise and nancy kerrigan"])
    ...
    assert_spot("singing in the phantom of the opera", {
        stick_prepositions: true
    }, ["phantom", "opera", "phantom of the opera"]);
    assert_spot("singing in the phantom of the opera", {
        stick_prepositions: true,
        gerund: true
    }, ["singing", "phantom", "opera", "singing in the phantom", "phantom of the opera"]);
    ...
    function assert_spot(str, obj) {
        var the = nlp.spot(str, {})
        the = _.pluck(_.pluck(the, "pos"), "tag")
        if (_.isEqual(the, obj)) {
            console.log('true');
        } else {
