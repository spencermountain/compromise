...
let arr = [
  ...
  ['Mitt Romney', '#FirstName #LastName'],
  ['Barack Obama', '#FirstName #LastName'],
  ['Obama', '#LastName'],
  ['Lady Gaga', '#Person+'],
  ['Kanye West', '#FirstName #LastName'],
  ...
  ['Halle Berry', '#FirstName #LastName'],
  ...
  ['Kobe Bryant', '#FirstName #LastName'],
