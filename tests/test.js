var tests = (function() {
    ...
    function test_others() {
        ...
        console.log(nlp.adjective.to_adverb('large') == 'largely')
        console.log(nlp.adjective.to_adverb('naive') == 'naively')
        console.log(nlp.adjective.to_adverb('unimaginable') == 'unimaginably')
        console.log(nlp.adjective.to_adverb('unthinkable') == 'unthinkably')
        console.log(nlp.adjective.to_adverb('amiable') == 'amiably')
        console.log(nlp.adjective.to_adverb('affable') == 'affably')
        console.log(nlp.adjective.to_adverb('livid') == 'lividly')
        console.log(nlp.adjective.to_adverb('tentative') == 'tentatively')
        console.log(nlp.adjective.to_adverb('wide') == 'widely')
        console.log(nlp.adjective.to_adverb('impracticable') == 'impracticably')
        console.log(nlp.adjective.to_adverb('gruesome') == 'gruesomely')
        console.log(nlp.adjective.to_adverb('jejune') == 'jejunely')
        console.log(nlp.adjective.to_adverb('immature') == 'immaturely')
        console.log(nlp.adjective.to_adverb('retentive') == 'retentively')
        console.log(nlp.adjective.to_adverb('desperate') == 'desperately')
        console.log(nlp.adjective.to_adverb('recognizable') == 'recognizably')
        console.log(nlp.adjective.to_adverb('close') == 'closely')
        console.log(nlp.adjective.to_adverb('unprofitable') == 'unprofitably')
        console.log(nlp.adjective.to_adverb('vapid') == 'vapidly')
        console.log(nlp.adjective.to_adverb('obscure') == 'obscurely')
        console.log(nlp.adjective.to_adverb('bad') == 'badly')
        console.log(nlp.adjective.to_adverb('indeterminable') == 'indeterminably')
        console.log(nlp.adjective.to_adverb('horrible') == 'horribly')
        console.log(nlp.adjective.to_adverb('shamefaced') == 'shamefacedly')
        console.log(nlp.adjective.to_adverb('suave') == 'suavely')
        console.log(nlp.adjective.to_adverb('ornate') == 'ornately')
        console.log(nlp.adjective.to_adverb('inattentive') == 'inattentively')
        console.log(nlp.adjective.to_adverb('abstracted') == 'abstractedly')
        console.log(nlp.adjective.to_adverb('absentminded') == 'absentmindedly')
        console.log(nlp.adjective.to_adverb('competitive') == 'competitively')
        console.log(nlp.adjective.to_adverb('secure') == 'securely')
        console.log(nlp.adjective.to_adverb('profitable') == 'profitably')
        console.log(nlp.adjective.to_adverb('productive') == 'productively')
        console.log(nlp.adjective.to_adverb('irritable') == 'irritably')
        console.log(nlp.adjective.to_adverb('unfashionable') == 'unfashionably')
        console.log(nlp.adjective.to_adverb('dense') == 'densely')
        console.log(nlp.adjective.to_adverb('visible') == 'visibly')
        console.log(nlp.adjective.to_adverb('noticeable') == 'noticeably')
        console.log(nlp.adjective.to_adverb('observable') == 'observably')
        console.log(nlp.adjective.to_adverb('perceptible') == 'perceptibly')
        console.log(nlp.adjective.to_adverb('inexpressive') == 'inexpressively')
        console.log(nlp.adjective.to_adverb('unproductive') == 'unproductively')
        console.log(nlp.adjective.to_adverb('imaginative') == 'imaginatively')
        console.log(nlp.adjective.to_adverb('incisive') == 'incisively')
        console.log(nlp.adjective.to_adverb('precise') == 'precisely')
        console.log(nlp.adjective.to_adverb('reserved') == 'reservedly')
        console.log(nlp.adjective.to_adverb('effusive') == 'effusively')
        console.log(nlp.adjective.to_adverb('square') == 'squarely')
