...
test('coreference:', function (t) {
  const arr = [
    ...
    // tricky:
    ['The queen, who did not believe in Firedrakes, alone took his side.', { his: 'the queen' }],
    [
    ...
    ['In 2010 she got engaged to a choreographer she met on the set of "Black Swan"', { she: 'a choreographer' }],
    [
    ...
    ['Then the magician went back and told to the Sultan his story.', { his: 'the magician' }],
    ...
    ['Putlibai gave Gandhi her permission and blessing.', { her: 'putlibai' }],
    ...
    ['Therefore, our menus stayed on the tables because they were too sticky to be removed.', { they: 'our menus' }],
    [
    ...
    [`the copy-holders had writings with their holdings.`, { their: 'the copy-holders' }],
    ...
    ['Men are of different heights, yet they range about a mode.', { they: 'men' }],
    [
    ...
    ['Some citizens in this Canadian capital get their news from the Citizen newspaper', { their: 'some citizens' }],
    [
      'In May 1961 he vowed to land a man on the moon & return him safely to Earth by the end of the decade',
      { him: 'a man' },
    ],
    ['These teeth usually erupt between the ages of 17 & 25, hence their popular name', { their: 'these teeth' }],
    [
    ...
    [`the committee gathered their delegates`, { their: 'the committee' }],
  ]
  arr.forEach(a => {
    const [text, refs] = a
    const doc = nlp(text)
