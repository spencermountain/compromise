...
test('modal questions require an explicit request marker', function (t) {
  const questions = [
    ...
    'could you not swim when you were young?',
    'could you quietly leave?',
  ...
  const requests = [
    ...
    ['could you please not leave?', 'leave'],
    ['could you not leave, please?', 'leave'],
    ['please could you quietly leave?', 'leave'],
    ['would you please really not leave?', 'leave'],
