...
test('or-match-basic', function (t) {
  ...
  t.equal(m.out(), 'toronto and montreal. Sydney and Paris', here + 'whitespace-or')

  m = doc.match('(#Place  | nonono no no| and )')
  t.equal(m.out(), 'toronto and montreal. Sydney and Paris', here + 'whitespace-or-multi1')

  m = doc.match('( nonono no no|| . )')
  t.equal(m.out(), 'toronto and montreal. Sydney and Paris', here + 'whitespace-or-dot')
  t.end()
})
