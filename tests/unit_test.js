...
exports["negation"] = function(test){
  ...
  // test.equal(negate("he goes to the store"), "he didn't go to the store")
  // test.equal(negate("she watches the movie"), "she didn't watch the movie")
  ...
  // [copula] - not
  test.equal(negate("he is an animal"), "he is not an animal")
  test.equal(negate("tom was a goofball"), "tom was not a goofball")
  // test.equal(negate("he will be a lion"), "he won't be a lion")
  // already negative (dont touch)
  test.equal(negate("he didn't go to the store"), "he didn't go to the store")
  test.equal(negate("she didn't watch the movie"), "she didn't watch the movie")
  test.equal(negate("he won't go to the store"), "he won't go to the store")
  test.equal(negate("she won't watch the movie"), "she won't watch the movie")
  test.equal(negate("he didn't go to the store"), "he didn't go to the store")
  test.equal(negate("she didn't watch the movie"), "she didn't watch the movie")
  // test.equal(negate("he will not be a lion"), "he will not be a lion")
  // other stuff
  ...
  // coumpound sentences
  // test.equal(negate("he will be a lion and will be on stage"), "he will not be a lion and be on stage")
  // test.equal(negate("he was a lion and will be on stage"), "he was not a lion and will be on stage")
  // test.equal(negate("They are based on different physical effects used to guarantee a stable grasping between a gripper and the object to be grasped."), "They are not based on different physical effects use to guarantee a stable grasping between a gripper and the object to be grasped.")
